...
static void ShowResultsBoard(void)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_2, gText_TimeBoard, 74, 0, 0xFF, ((void *)0));
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        AddTextPrinterParameterized(windowId, FONT_2, gTrainerTowerChallengeTypeTexts[i - 1], 24, 36 + 20 * i, 0xFF, ((void *)0));
        AddTextPrinterParameterized(windowId, FONT_2, gStringVar4, 96, 46 + 20 * i, 0xFF, ((void *)0));
    }
