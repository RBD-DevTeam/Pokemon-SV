...
static const struct DoorGraphics sDoorGraphics[] = {
    {0x03D, 0, 0, sDoorAnimTiles_General, sDoorAnimPalettes_General},
    {0x062, 1, 0, sDoorAnimTiles_SlidingSingle, sDoorAnimPalettes_SlidingSingle},
    {0x15B, 1, 0, sDoorAnimTiles_SlidingDouble, sDoorAnimPalettes_SlidingDouble},
    {0x2A3, 0, 0, sDoorAnimTiles_Pallet, sDoorAnimPalettes_Pallet},
    {0x2AC, 0, 0, sDoorAnimTiles_OaksLab, sDoorAnimPalettes_OaksLab},
    {0x299, 0, 0, sDoorAnimTiles_Viridian, sDoorAnimPalettes_Viridian},
    {0x2CE, 0, 0, sDoorAnimTiles_Pewter, sDoorAnimPalettes_Pewter},
    {0x284, 0, 0, sDoorAnimTiles_Saffron, sDoorAnimPalettes_Saffron},
    {0x2BC, 1, 0, sDoorAnimTiles_SilphCo, sDoorAnimPalettes_SilphCo},
    {0x298, 0, 0, sDoorAnimTiles_Cerulean, sDoorAnimPalettes_Cerulean},
    {0x2A2, 0, 0, sDoorAnimTiles_Lavender, sDoorAnimPalettes_Lavender},
    {0x29E, 0, 0, sDoorAnimTiles_Vermilion, sDoorAnimPalettes_Vermilion},
    {0x2E1, 0, 0, sDoorAnimTiles_PokemonFanClub, sDoorAnimPalettes_PokemonFanClub},
    {0x294, 1, 0, sDoorAnimTiles_DeptStore, sDoorAnimPalettes_DeptStore},
    {0x2BF, 0, 0, sDoorAnimTiles_Fuchsia, sDoorAnimPalettes_Fuchsia},
    {0x2D2, 1, 0, sDoorAnimTiles_SafariZone, sDoorAnimPalettes_SafariZone},
    {0x2AD, 0, 0, sDoorAnimTiles_CinnabarLab, sDoorAnimPalettes_CinnabarLab},
    {0x297, 0, 0, sDoorAnimTiles_Sevii123, sDoorAnimPalettes_Sevii123},
    {0x29B, 1, 0, sDoorAnimTiles_JoyfulGameCorner, sDoorAnimPalettes_JoyfulGameCorner},
    {0x2EB, 0, 0, sDoorAnimTiles_OneIslandPokeCenter, sDoorAnimPalettes_OneIslandPokeCenter},
    {0x29A, 0, 0, sDoorAnimTiles_Sevii45, sDoorAnimPalettes_Sevii45},
    {0x2B9, 0, 0, sDoorAnimTiles_FourIslandDayCare, sDoorAnimPalettes_FourIslandDayCare},
    {0x2AF, 0, 0, sDoorAnimTiles_RocketWarehouse, sDoorAnimPalettes_RocketWarehouse},
    {0x30C, 0, 0, sDoorAnimTiles_Sevii67, sDoorAnimPalettes_Sevii67},
    {0x28D, 1, 1, sDoorAnimTiles_DeptStoreElevator, sDoorAnimPalettes_DeptStoreElevator},
    {0x2DE, 1, 1, sDoorAnimTiles_CableClub, sDoorAnimPalettes_CableClub},
    {0x2AB, 1, 1, sDoorAnimTiles_HideoutElevator, sDoorAnimPalettes_HideoutElevator},
    {0x281, 0, 1, sDoorAnimTiles_SSAnne, sDoorAnimPalettes_SSAnne},
    {0x2E2, 1, 1, sDoorAnimTiles_SilphCoElevator, sDoorAnimPalettes_SilphCoElevator},
    {0x296, 1, 1, sDoorAnimTiles_Teleporter, sDoorAnimPalettes_Teleporter},
    {0x2C3, 1, 1, sDoorAnimTiles_TrainerTowerLobbyElevator, sDoorAnimPalettes_TrainerTowerLobbyElevator},
    {0x356, 1, 1, sDoorAnimTiles_TrainerTowerRoofElevator, sDoorAnimPalettes_TrainerTowerRoofElevator},
    {}
};
...
static void LoadDoorFrameTiles(const u8 *a0)
{
    CpuFastSet(a0, (void *)(0x6000000 + 0x7F00), ((0x100)/(32/8) & 0x1FFFFF));
}
...
{
    if (GetDoorSoundType(sDoorGraphics, x, y) == 0)
        return 241;
    else
        return 18;
}
