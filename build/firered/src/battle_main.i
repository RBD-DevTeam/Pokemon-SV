...
static void BattleStartClearSetData(void)
{
    ...
    *(&gBattleStruct->safariEscapeFactor) = gBaseStats[GetMonData(&gEnemyParty[0], 11)].safariZoneFleeRate * 100 / 1275;
...
static void HandleAction_WatchesCarefully(void)
{
    ...
    if (gBattleStruct->safariRockThrowCounter != 0)
    {
        ...
        if (gBattleStruct->safariRockThrowCounter == 0)
        {
            *(&gBattleStruct->safariCatchFactor) = gBaseStats[GetMonData(gEnemyParty, 11)].catchRate * 100 / 1275;
            gBattleCommunication[5] = 0;
        }
        else
        {
