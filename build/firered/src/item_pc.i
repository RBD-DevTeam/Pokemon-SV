...
static void ItemPc_DoWithdraw(u8 taskId)
{
    ...
    if (AddBagItem(itemId, data[8]) == 1)
    {
        ...
        AddTextPrinterParameterized(windowId, FONT_2, gStringVar4, 0, 2, 0, ((void *)0));
        gTasks[taskId].func = Task_ItemPcWaitButtonAndFinishWithdrawMultiple;
    }
    else
    {
        windowId = ItemPc_GetOrCreateSubwindow(2);
        AddTextPrinterParameterized(windowId, FONT_2, gText_NoMoreRoomInBag, 0, 2, 0, ((void *)0));
...
static void ItemPc_WithdrawMultipleInitWindow(u16 slotId)
{
    ...
    AddTextPrinterParameterized(ItemPc_GetOrCreateSubwindow(1), FONT_2, gStringVar4, 0, 2, 0, ((void *)0));
...
static void ItemPc_SetBorderStyleOnWindow(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x3C0, 0x0E);
}
...
static u8 ItemPc_GetOrCreateSubwindow(u8 idx)
{
    if (sSubmenuWindowIds[idx] == 0xFF)
    {
        ...
        DrawStdFrameWithCustomTileAndPalette(sSubmenuWindowIds[idx], 1, 0x3A3, 0x0C);
    }
