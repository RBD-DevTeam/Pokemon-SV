...
void ApplyGlobalFieldPaletteTint(u8 paletteIdx)
{
    ...
    CpuFastSet(&gPlttBufferUnfaded[(paletteIdx + 16) * 16], &gPlttBufferFaded[(paletteIdx + 16) * 16], ((0x20)/(32/8) & 0x1FFFFF));
}
