...
static void StartSweetScentFieldEffect(void)
{
    ...
    PlaySE(229);
    sPlttBufferBak = (u8 *)Alloc(0x400);
    CpuFastSet(gPlttBufferUnfaded, sPlttBufferBak, ((0x400)/(32/8) & 0x1FFFFF));
...
static void FailSweetScentEncounter(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        CpuFastSet(sPlttBufferBak, gPlttBufferUnfaded, ((0x400)/(32/8) & 0x1FFFFF));
