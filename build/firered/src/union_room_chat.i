...
static void ChatEntryRoutine_Disbanded(void)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (RunDisplaySubtask(0) != 1 && IsLinkTaskFinished() && !RfuHasFoundNewLeader())
        {
            SetCloseLinkCallback();
            sWork->exitDelayTimer = 0;
            sWork->routineState++;
...
static void ChatEntryRoutine_SendMessage(void)
{
    ...
    case 1:
        if (IsLinkTaskFinished() == 1 && !RfuHasFoundNewLeader() && SendBlock(0, sWork->sendMessageBuffer, sizeof(sWork->sendMessageBuffer)))
            sWork->routineState++;
        break;
    case 2:
...
static void Task_ReceiveChatMessage(u8 taskId)
{
    ...
    case 1:
        ...
        if (!data[3] && RfuHasFoundNewLeader())
            return;
