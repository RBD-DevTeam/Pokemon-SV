...
static const struct Subsprite gUnknown_8260358[] = {
    { 240, 0, (((3 << 2) | (1)) & 0x03), ((((3 << 2) | (1)) >> 2) & 0x03), 0x0000, 1 },
    { 48, 0, (((2 << 2) | (0)) & 0x03), ((((2 << 2) | (0)) >> 2) & 0x03), 0x0020, 1 },
    { 240, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0030, 1 },
    { 16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0034, 1 },
    { 48, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0038, 1 }
};

static const struct Subsprite gUnknown_826036C[] = {
    { 240, 0, (((3 << 2) | (1)) & 0x03), ((((3 << 2) | (1)) >> 2) & 0x03), 0x0040, 1 },
    { 48, 0, (((2 << 2) | (0)) & 0x03), ((((2 << 2) | (0)) >> 2) & 0x03), 0x0060, 1 },
    { 240, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0070, 1 },
    { 16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0074, 1 },
    { 48, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0078, 1 }
};
...
static const struct Subsprite gUnknown_8260390[] = {
    { 240, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0000, 1 },
    { 16, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0004, 1 }
};

static const struct Subsprite gUnknown_8260398[] = {
    { 240, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0000, 1 },
    { 16, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0004, 1 },
    { 224, 0, (((0 << 2) | (0)) & 0x03), ((((0 << 2) | (0)) >> 2) & 0x03), 0x0008, 1 }
};

static const struct SubspriteTable gUnknown_82603A4[] = {
    {(sizeof(gUnknown_8260358) / sizeof((gUnknown_8260358)[0])), gUnknown_8260358},
    {(sizeof(gUnknown_8260380) / sizeof((gUnknown_8260380)[0])), gUnknown_8260380},
    {(sizeof(gUnknown_826036C) / sizeof((gUnknown_826036C)[0])), gUnknown_826036C},
    {(sizeof(gUnknown_8260388) / sizeof((gUnknown_8260388)[0])), gUnknown_8260388}
};

static const struct SubspriteTable gUnknown_82603C4[] = {
    {(sizeof(gUnknown_8260390) / sizeof((gUnknown_8260390)[0])), gUnknown_8260390},
    {(sizeof(gUnknown_8260398) / sizeof((gUnknown_8260398)[0])), gUnknown_8260398}
};

static const struct Subsprite gUnknown_82603D4[] = {
    { 160, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0000, 1 },
    { 192, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0004, 1 },
    { 224, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0008, 1 },
    { 0, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x000c, 1 }
};
...
static const struct Subsprite gUnknown_82603E4[] = {
    ...
    { 192, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0004, 1 },
    { 224, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0008, 1 },
    { 0, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0008, 1 },
    { 32, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x0008, 1 },
    { 64, 0, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 0x000c, 1 }
};

static const struct SubspriteTable sStatusSummaryBar_SubspriteTable[] =
{
    {(sizeof(gUnknown_82603D4) / sizeof((gUnknown_82603D4)[0])), gUnknown_82603D4}
};

static const struct SubspriteTable gUnknown_8260404[] = {
    {(sizeof(gUnknown_82603E4) / sizeof((gUnknown_82603E4)[0])), gUnknown_82603E4}
};
...
{
    dest[4] = 0x1E;
    sub_8047B0C(num2, &dest[0], 0);
    sub_8047B0C(num1, &dest[5], 1);
}
# 511 "src/battle_interface.c"
u8 CreateBattlerHealthboxSprites(u8 a)
{
    ...
    if (!IsDoubleBattle())
    {
        if (GetBattlerSide(a) == 0)
        {
            ...
            gSprites[healthboxLeftSpriteId].oam.shape = (((3 << 2) | (0)) & 0x03);
            gSprites[healthboxRightSpriteId].oam.shape = (((3 << 2) | (0)) & 0x03);
    ...
    CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_1), (void *)(0x6000000 + 0x10000) + sprite->oam.tileNum * 32, 0x04000000 | ((64)/(32/8) & 0x1FFFFF));

    gSprites[healthboxLeftSpriteId].data[5] = healthbarSpriteId;
    gSprites[healthboxLeftSpriteId].data[6] = a;
...
void UpdateHpTextInHealthbox(u8 healthboxSpriteId, s16 value, u8 maxOrCurrent)
{
    ...
    else
    {
        ...
        else
        {
            ...
            for (i = 0; i < 3; i++)
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[i * 64 + 32], (void *)(((void *)(0x6000000 + 0x10000)) + 32 * (gSprites[healthboxSpriteId].oam.tileNum + var + i)), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF))
...
static void UpdateHpTextInHealthboxInDoubles(u8 healthboxSpriteId, s16 value, u8 maxOrCurrent)
{
    ...
    if (gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
    {
        ...
        for (i = var; i < var + 3; i++)
        {
            if (i < 3)
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[((i - var) * 64) + 32], (void *)(((void *)(0x6000000 + 0x10000)) + 32 * (1 + gSprites[r7].oam.tileNum + i)), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF))

                               ;
            }
            else
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[((i - var) * 64) + 32], (void *)(((void *)(0x6000000 + 0x10000) + 0x20) + 32 * (i + gSprites[r7].oam.tileNum)), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF))
        ...
        if (maxOrCurrent == HP_CURRENT)
        {
            CpuSet(&gMonSpritesGfxPtr->barFontGfx[224], (void *)(((void *)(0x6000000 + 0x10000)) + ((gSprites[r7].oam.tileNum + 4) * 32)), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF))

                           ;
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(((void *)(0x6000000 + 0x10000)) + (gSprites[r7].oam.tileNum * 32)), 0x04000000 | 0x01000000 | ((0x20)/(32/8) & 0x1FFFFF)); };
        }
        else
        {
            if (GetBattlerSide(battlerId) == 0)
            {
                CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_116), (void *)((void *)(0x6000000 + 0x10000)) + ((gSprites[healthboxSpriteId].oam.tileNum + 52) * 32), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF))
            ...
            && (IsDoubleBattle() || GetBattlerSide(i) != 0))
        {
            ...
            if (GetBattlerSide(i) == 0)
            {
                ...
                if (noBars == 1)
                {
                    ...
                    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | 0x01000000 | ((0x100)/(32/8) & 0x1FFFFF)); };
                ...
                else
                {
                    ...
                    CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_117), (void *)((void *)(0x6000000 + 0x10000) + 0x680 + gSprites[gHealthboxSpriteIds[i]].oam.tileNum * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF));
                }
            }
            else
            {
...
void TryAddPokeballIconToHealthbox(u8 healthboxSpriteId, bool8 noStatus)
{
    ...
    if (noStatus)
        CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_70), (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 8) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF));
    else
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 8) * 32), 0x04000000 | 0x01000000 | ((32)/(32/8) & 0x1FFFFF)); };
}
...
static void UpdateStatusIconInHealthbox(u8 healthboxSpriteId)
{
    ...
    else
    {
        ...
        for (i = 0; i < 3; i++)
            CpuSet(statusGfxPtr, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthboxSpriteId].oam.tileNum + tileNumAdder + i) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF));

        if (!gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
            CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_1), (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | ((64)/(32/8) & 0x1FFFFF));
    ...
    CpuSet(statusGfxPtr, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthboxSpriteId].oam.tileNum + tileNumAdder) * 32), 0x04000000 | ((96)/(32/8) & 0x1FFFFF));
    if (IsDoubleBattle() == 1 || GetBattlerSide(battlerId) == 1)
    {
        if (!gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
        {
            CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_0), (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF));
            CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_65), (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 1) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF));
        }
    }
...
static void UpdateLeftNoOfBallsTextOnHealthbox(u8 healthboxSpriteId)
{
    ...
    windowTileData = AddTextPrinterAndCreateWindowOnHealthbox(text, ({ s32 w = GetStringWidth(0, text, 0); 0x2F - w; }), 3, &windowId);
    spriteTileNum = gSprites[healthboxSpriteId].oam.tileNum * 32;
...
s32 MoveBattleBar(u8 battlerId, u8 healthboxSpriteId, u8 whichBar, u8 unused)
{
    ...
    else
    {
        ...
        if (expFraction == 0)
            expFraction = 1;
        expFraction = ((gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / expFraction) < 0 ? -(gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / expFraction) : (gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / expFraction));
...
static void MoveBattleBarGraphically(u8 battlerId, u8 whichBar)
{
    ...
    case HEALTH_BAR:
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            if (i < 2)
                CpuSet(GetHealthboxElementGfxPtr(barElementId) + array[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthbarSpriteId].oam.tileNum + 2 + i) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF))
                                                                                                                       ;
            else
                CpuSet(GetHealthboxElementGfxPtr(barElementId) + array[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + 64 + (i + gSprites[healthbarSpriteId].oam.tileNum) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF))
                                                                                                                        ;
        }
        break;
    case EXP_BAR:
        ...
        {
            if (i < 4)
                CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_12) + array[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[gBattleSpritesDataPtr->battleBars[battlerId].healthboxSpriteId].oam.tileNum + 0x24 + i) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF))
                                                                                                                                                                       ;
            else
                CpuSet(GetHealthboxElementGfxPtr(HEALTHBOX_GFX_12) + array[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + 0xB80 + (i + gSprites[gBattleSpritesDataPtr->battleBars[battlerId].healthboxSpriteId].oam.tileNum) * 32), 0x04000000 | ((32)/(32/8) & 0x1FFFFF))
                                                                                                                                                                        ;
        }
        break;
    }
...
static s32 CalcNewBarValue(s32 maxValue, s32 oldValue, s32 receivedValue, s32 *currValue, u8 scale, u16 toAdd)
{
    ...
    if (maxValue < scale)
    {
        s32 toAdd_ = ((s32)((maxValue) << 8)) / scale;
