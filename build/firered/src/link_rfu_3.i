...
static __attribute__((section("ewram_data"))) u8 gWirelessStatusIndicatorSpriteId = 0;
...
void InitHostRFUtgtGname(struct GFtgtGname *data, u8 activity, bool32 started, s32 child_sprite_genders)
{
    ...
    data->unk_00.version = 4;
    data->unk_00.hasNews = 0;
    data->unk_00.hasCard = 0;
    data->unk_00.unknown = 0;
    data->unk_00.isChampion = FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x44));
    data->unk_00.hasNationalDex = IsNationalPokedexEnabled();
    data->unk_00.gameClear = FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x2C));
}
# 708 "src/link_rfu_3.c"
bool8 LinkRfu_GetNameIfCompatible(struct GFtgtGname *gname, u8 *uname, u8 idx)
{
    bool8 retVal;
    ...
    if (lman.parent_child == 0x01)
    {
        ...
        {
            memcpy(gname, &gRfuLinkStatus->partner[idx].gname, 13);
            memcpy(uname, gRfuLinkStatus->partner[idx].uname, 8);
        }
        else
        {
            memset(gname, 0, 13);
...
void LinkRfu3_SetGnameUnameFromStaticBuffers(struct GFtgtGname *gname, u8 *uname)
{
    memcpy(gname, &gHostRFUtgtGnameBuffer, 13);
    memcpy(uname, gHostRFUtgtUnameBuffer, 8);
}
# 781 "src/link_rfu_3.c"
