...
static void PrintCoinsString_Parameterized(u8 windowId, u32 coinAmount, u8 x, u8 y, u8 speed)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_0, gStringVar4, x, y, speed, ((void *)0));
}
...
void PrintCoinsString(u32 coinAmount)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_0, gStringVar4, 64 - width, 0xC, 0, ((void *)0));
}
...
void ShowCoinsWindow(u32 coinAmount, u8 x, u8 y)
{
    ...
    DrawStdFrameWithCustomTileAndPalette(sCoinsWindowId, 0, 0x21D, 0xD);
