...
static void EvoTask_PostEvoSparklesSet2Init(u8 taskId)
{
    ...
    CpuSet(&gPlttBufferFaded[32], &gPlttBufferUnfaded[32], 0x00000000 | ((96)/(16/8) & 0x1FFFFF));
...
u8 CycleEvolutionMonSprite(u8 preEvoSpriteId, u8 postEvoSpriteId)
{
    ...
    CpuSet(palette, &gPlttBufferFaded[256 + 16 * gSprites[preEvoSpriteId].oam.paletteNum], 0x00000000 | ((32)/(16/8) & 0x1FFFFF));
    ...
    CpuSet(palette, &gPlttBufferFaded[256 + 16 * gSprites[postEvoSpriteId].oam.paletteNum], 0x00000000 | ((32)/(16/8) & 0x1FFFFF));
