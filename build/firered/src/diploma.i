...
static void DiplomaPrintText(void)
{
    ...
    AddTextPrinterParameterized3(WIN_TEXT, FONT_2, 120 - (width / 2), 4, sTextColors, 0xFF, str);
    DynamicPlaceholderTextUtil_ExpandPlaceholders(str, gText_Diploma_ThisDocument);
    width = GetStringWidth(FONT_2, str, -1);
    AddTextPrinterParameterized3(WIN_TEXT, FONT_2, 120 - (width / 2), 30, sTextColors, 0xFF, str);
