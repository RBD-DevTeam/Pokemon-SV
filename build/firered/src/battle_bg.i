...
void LoadBattleMenuWindowGfx(void)
{
    ...
    gPlttBufferUnfaded[0x5C] = ((9) | ((9) << 5) | ((9) << 10));
    gPlttBufferUnfaded[0x5D] = ((9) | ((9) << 5) | ((9) << 10));
    gPlttBufferUnfaded[0x5E] = ((31) | ((31) << 5) | ((31) << 10));
    gPlttBufferUnfaded[0x5F] = ((26) | ((26) << 5) | ((25) << 10));
    CpuSet(&gPlttBufferUnfaded[0x5C], &gPlttBufferFaded[0x5C], 0x00000000 | ((8)/(16/8) & 0x1FFFFF));
    if (gBattleTypeFlags & ((1 << 4) | (1 << 16)))
    {
        Menu_LoadStdPalAt(0x70);
        LoadMenuMessageWindowGfx(0, 0x030, 0x70);
        gPlttBufferUnfaded[0x76] = ((0) | ((0) << 5) | ((0) << 10));
...
void LoadBattleTextboxAndBackground(void)
{
    LZDecompressVram(gBattleTextboxTiles, (void *)(void *)(0x6000000 + (0x4000 * (0))));
...
void InitLinkBattleVsScreen(u8 taskId)
{
    ...
    case 1:
        ...
        gPlttBufferUnfaded[palId * 16 + 0x10F] = gPlttBufferFaded[palId * 16 + 0x10F] = ((31) | ((31) << 5) | ((31) << 10));
