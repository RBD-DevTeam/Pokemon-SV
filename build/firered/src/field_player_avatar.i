...
static bool8 Fishing5(struct Task *task)
{
    ...
    if (task->data[1] >= 20)
    {
        ...
        {
            AddTextPrinterParameterized(0, FONT_2, dot, task->data[2] * 12, 1, 0, ((void *)0));
            task->data[2]++;
        }
    }
    return 0;
...
static bool8 Fishing10(struct Task *task)
{
    ...
    AddTextPrinterParameterized2(0, FONT_2, gText_PokemonOnHook, 1, 0, 0x2, 0x1, 0x3);
    task->data[0]++;
    task->data[1] = 0;
    return 0;
}
...
static bool8 Fishing12(struct Task *task)
{
    ...
    FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
    AddTextPrinterParameterized2(0, FONT_2, gText_NotEvenANibble, 1, ((void *)0), 0x2, 0x1, 0x3);
    task->data[0] = 13;
    return 1;
}
...
static bool8 Fishing13(struct Task *task)
{
    AlignFishingAnimationFrames(&gSprites[gPlayerAvatar.spriteId]);
    StartSpriteAnim(&gSprites[gPlayerAvatar.spriteId], GetFishingNoCatchDirectionAnimNum(GetPlayerFacingDirection()));
    AddTextPrinterParameterized2(0, FONT_2, gText_ItGotAway, 1, ((void *)0), 0x2, 0x1, 0x3);
    task->data[0]++;
    return 1;
}
