...
static __attribute__((section("ewram_data"))) bool32 sReceivedWonderCardIsValid = 0;
...
static void BlankMENewsJisan(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, GetMENewsJisanStructPtr(), 0x04000000 | 0x01000000 | ((sizeof(struct WonderNewsMetadata))/(32/8) & 0x1FFFFF)); };
    MENewsJisanReset();
}
...
static void BlankSavedWonderCard(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1Ptr->mysteryGift.card, 0x04000000 | 0x01000000 | ((sizeof(struct WonderCard))/(32/8) & 0x1FFFFF)); };
...
bool32 CheckReceivedGiftFromWonderCard(void)
{
    ...
    if (!IsCardIdInValidRange(value))
        return 0;
    if (FlagGet(sGiftItemFlagIds[value - 1000]) == 1)
        return 0;
    return 1;
}
...
{
    s32 i;
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, data, 0x04000000 | 0x01000000 | ((sizeof(struct MEventClientHeaderStruct))/(32/8) & 0x1FFFFF)); };
