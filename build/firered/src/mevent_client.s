...
.Lfe9:
	...
	.align	2, 0
	.type	 client_mainseq_0,function
	.thumb_func
client_mainseq_0:
	push	{r4, lr}
	add	r4, r0, #0
...
.L28:
	.align	2, 0
.L27:
	.word	gMEventClientScript_InitialListen
.Lfe10:
	.size	 client_mainseq_0,.Lfe10-client_mainseq_0
	.align	2, 0
	.type	 client_mainseq_1,function
	.thumb_func
client_mainseq_1:
	mov	r0, #0x6
	bx	lr
.Lfe11:
	.size	 client_mainseq_1,.Lfe11-client_mainseq_1
	.align	2, 0
	.type	 client_mainseq_2,function
	.thumb_func
client_mainseq_2:
	push	{r4, lr}
	add	r4, r0, #0
...
.L31:
	...
	bx	r1
.Lfe12:
	.size	 client_mainseq_2,.Lfe12-client_mainseq_2
	.align	2, 0
	.type	 client_mainseq_3,function
	.thumb_func
client_mainseq_3:
	push	{r4, lr}
	add	r4, r0, #0
...
.L33:
	...
	bx	r1
.Lfe13:
	.size	 client_mainseq_3,.Lfe13-client_mainseq_3
	.align	2, 0
	.type	 client_mainseq_4,function
	.thumb_func
client_mainseq_4:
	push	{r4, lr}
	add	r4, r0, #0
...
.L53:
	ldr	r0, [r4, #0x18]
	bl	OverwriteSavedWonderCardWithReceivedCard
	b	.L35
.L54:
	ldr	r0, [r4, #0x18]
	bl	MEvent_HaveAlreadyReceivedWonderNews
	cmp	r0, #0
	bne	.L55	@cond_branch
	ldr	r0, [r4, #0x18]
	bl	OverwriteSavedWonderNewsWithReceivedNews
	add	r0, r4, #0
	mov	r1, #0x13
	mov	r2, #0x0
	bl	mevent_client_send_word
...
.L58:
	ldr	r0, [r4, #0x18]
	bl	MEvent_ReceiveDistributionMon
	b	.L35
.L59:
	ldr	r0, [r4, #0x18]
	mov	r1, #0xfa
...
.Lfe14:
	.size	 client_mainseq_4,.Lfe14-client_mainseq_4
	.align	2, 0
	.type	 client_mainseq_5,function
	.thumb_func
client_mainseq_5:
	push	{lr}
	add	r1, r0, #0
...
.L73:
	...
	bx	r1
.Lfe15:
	.size	 client_mainseq_5,.Lfe15-client_mainseq_5
	.align	2, 0
	.type	 client_mainseq_6,function
	.thumb_func
client_mainseq_6:
	push	{r4, lr}
	add	r4, r0, #0
...
.L75:
	...
	bx	r1
.Lfe16:
	.size	 client_mainseq_6,.Lfe16-client_mainseq_6
	.align	2, 0
	.type	 client_mainseq_7,function
	.thumb_func
client_mainseq_7:
	push	{r4, lr}
	add	r4, r0, #0
...
.L83:
	...
	.word	gSaveBlock1Ptr
.Lfe17:
	.size	 client_mainseq_7,.Lfe17-client_mainseq_7
	.section .rodata
	.align	2, 0
.LC12:
	.word	client_mainseq_0
	.word	client_mainseq_1
	.word	client_mainseq_2
	.word	client_mainseq_3
	.word	client_mainseq_4
	.word	client_mainseq_5
	.word	client_mainseq_6
	.word	client_mainseq_7
.text
	.align	2, 0
