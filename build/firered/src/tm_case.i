...
extern __attribute__((section("ewram_data"))) struct ItemSlot gUnknown_02039F80[3];
...
static __attribute__((section("ewram_data"))) struct UnkStruct_203B10C sTMCaseStaticResources = {};
static __attribute__((section("ewram_data"))) struct UnkStruct_203B118 * sTMCaseDynamicResources = ((void *)0);
static __attribute__((section("ewram_data"))) struct UnkStruct_203B11C * sPokedudePackBackup = ((void *)0);
...
static bool8 DoSetUpTMCaseUI(void)
{
    ...
    case 15:
        ...
        break;
    case 16:
        sTMCaseDynamicResources->tmSpriteId = CreateTMSprite(BagGetItemIdByPocketPosition(4, sTMCaseStaticResources.scrollOffset + sTMCaseStaticResources.selectedRow));
        gMain.state++;
        break;
    case 17:
...
static void TMCase_ItemPrintFunc(u8 windowId, u32 itemId, u8 y)
{
    if (itemId != -2)
    {
        if (!itemid_is_unique(BagGetItemIdByPocketPosition(4, itemId)))
        {
            ConvertIntToDecimalStringN(gStringVar1, BagGetQuantityByPocketPosition(4, itemId), STR_CONV_MODE_RIGHT_ALIGN, 3);
...
static void Task_FadeOutAndCloseTMCase(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        if (sTMCaseDynamicResources->savedCallback != ((void *)0))
...
static void Task_TMCaseMain(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        if (MenuHelpers_CallLinkSomething() != 1)
        {
            ...
            if (({(gMain.newKeys) & (0x0004);}) && sTMCaseStaticResources.unk_05 == 1)
            {
                PlaySE(5);
...
static void Task_SelectTMAction_FromFieldBag(u8 taskId)
{
    ...
    if (!MenuHelpers_LinkSomething() && InUnionRoom() != 1)
    {
...
static void Task_SelectTMAction_Type1(u8 taskId)
{
    ...
    if (!itemid_is_unique(BagGetItemIdByPocketPosition(4, data[1])))
    {
...
static void Task_AskConfirmSaleWithAmount(u8 taskId)
{
    ...
    ConvertIntToDecimalStringN(gStringVar3, itemid_get_market_price(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8], STR_CONV_MODE_LEFT_ALIGN, 6);
...
static void Task_InitQuantitySelectUI(u8 taskId)
{
    ...
    SellTM_PrintQuantityAndSalePrice(1, itemid_get_market_price(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8]);
    HandlePrintMoneyOnHand();
...
static void Task_QuantitySelect_HandleInput(u8 taskId)
{
    ...
    {
        SellTM_PrintQuantityAndSalePrice(data[8], itemid_get_market_price(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8]);
    }
...
static void Task_TMCaseDude_Playback(u8 taskId)
{
    ...
    case 18:
        FillBG2RowWithPalette_2timesNplus1(1);
        TMCase_PrintMessageWithFollowupTask(taskId, FONT_4, gPokedudeText_ReadTMDescription, ((void *)0));
        gTasks[taskId].func = Task_TMCaseDude_Playback;
        data[8]++;
        break;
    case 20:
...
static void TMCase_SetWindowBorder1(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x5B, 0x0E);
}

static void TMCase_SetWindowBorder2(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x78, 0x0D);
}
...
static void RemoveTMContextMenu(u8 * a0)
{
    ClearStdWindowAndFrameToTransparent(*a0, 0);
...
static void TintTMSpriteByType(u8 type)
{
    ...
    if (sTMCaseStaticResources.tmCaseMenuType == 4)
    {
        BlendPalettes(1 << (0x10 + palIndex), 4, ((0) | ((0) << 5) | ((0) << 10)));
    }
}
