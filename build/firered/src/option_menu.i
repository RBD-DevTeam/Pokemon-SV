...
static void Task_OptionMenu(u8 taskId)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (((bool32)MenuHelpers_CallLinkSomething()) == 1)
            break;
...
static void PrintOptionMenuHeader(void)
{
    ...
    AddTextPrinterParameterized(WIN_TEXT_OPTION, FONT_2, gText_Option, 8, 1, 0xFF, ((void *)0));
    PutWindowTilemap(0);
...
static void LoadOptionMenuItemNames(void)
{
    ...
    for (i = 0; i < MENUITEM_COUNT; i++)
    {
        AddTextPrinterParameterized(WIN_OPTIONS, FONT_2, sOptionMenuItemsNames[i], 8, (u8)((i * (GetFontAttribute(FONT_2, FONTATTR_MAX_LETTER_HEIGHT))) + 2) - i, 0xFF, ((void *)0));
    }
}
