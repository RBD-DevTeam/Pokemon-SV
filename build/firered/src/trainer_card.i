...
static void Task_TrainerCard(u8 taskId)
{
    ...
    case 15:
        ...
        AddTextPrinterParameterized(0, FONT_2, gText_WaitingTrainerFinishReading, 0, 1, 0xFF, 0);
...
static void CreateTrainerCardTrainerPic(void)
{
    ...
    else
    {
        ...
        {
            CreateTrainerCardTrainerPicSprite(PlayerGenderToFrontTrainerPicId_Debug(sTrainerCardDataPtr->trainerCard.rse.gender, 1), 1,
