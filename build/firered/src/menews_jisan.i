...
# 6 "src/menews_jisan.c" 2
# 1 "include/constants/items.h" 1
# 7 "src/menews_jisan.c" 2
...
void MENewsJisan_SetRandomReward(u32 a0)
{
    ...
    case 1:
    case 2:
        r5->berry = (Random() % 15) + (((148 - 133) + 1));
        break;
    case 3:
        r5->berry = (Random() % 15) + (((133 - 133) + 1));
        break;
    }
}
