...
static u16 MapNamePopupCreateWindow(bool32 palintoFadedBuffer)
{
    ...
    {
        CpuSet(GetTextWindowPalette(3), &gPlttBufferUnfaded[0xd0], 0x00000000 | ((0x20)/(16/8) & 0x1FFFFF));
    }
...
static void MapNamePopupPrintMapNameOnWindow(u16 windowId)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_2, mapName, xpos, 2, 0xFF, ((void *)0));
}
