...
static void PlaceYesNoMenuAt(u8 left, u8 top, u8 initialCursorPos)
{
    ...
    if (sWork->yesNoMenuWinId != 0xFF)
    {
        ...
        AddTextPrinterParameterized(sWork->yesNoMenuWinId, FONT_2, gText_Yes, 8, 2, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sWork->yesNoMenuWinId, FONT_2, gText_No, 8, 16, 0xFF, ((void *)0));
...
static void PrintOnWin1Parameterized(u16 x, u8 *str, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized3(1, FONT_2, x * 8, 1, color, 0xFF, strbuf);
}
...
static void PrintCurrentKeyboardPage(void)
{
    ...
    if (page != UNION_ROOM_KB_PAGE_COUNT)
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            AddTextPrinterParameterized3(2, FONT_0, left, top, color, 0xFF, str);
        }
    }
    else
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            {
                AddTextPrinterParameterized3(2, FONT_0, left, top, color, 0xFF, str2);
            }
            else
            {
                ...
                AddTextPrinterParameterized3(2, FONT_0, left, top, color, 0xFF, str);
                AddTextPrinterParameterized3(2, FONT_0, left + 35, top, color, 0xFF, gText_Ellipsis);
            }
        }
    }
}
...

{
    ...
    AddTextPrinterParameterized3(0, FONT_2, 0, row * 15, color, 0xFF, str);
}
