...
static u32 common_mainseq_4(struct mevent_srv_common * svr)
{
    ...
    {
        case 0:
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 354, "cmd->parameter == NULL", 1);;
            svr->mainseqno = 1;
            svr->param = cmd->flag;
            break;
        case 1:
            ...
            break;
        case 2:
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 364, "cmd->parameter == NULL", 1);;
            mevent_srv_sub_init_recv(&svr->manager, cmd->flag, svr->recvBuffer);
            svr->mainseqno = 2;
            break;
        case 3:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 370, "cmd->flag == FALSE", 1);;
            svr->cmdidx = 0;
            svr->cmdBuffer = cmd->parameter;
            break;
        case 5:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 376, "cmd->flag == FALSE", 1);;
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 377, "cmd->parameter == NULL", 1);;
            memcpy(svr->mevent_unk1442cc, svr->recvBuffer, sizeof(struct MEventClientHeaderStruct));
            break;
        case 6:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 382, "cmd->flag == FALSE", 1);;
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 383, "cmd->parameter == NULL", 1);;
        ...
        case 4:
            ...
            break;
        case 7:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 396, "cmd->flag == FALSE", 1);;
            ptr = mevent_first_if_not_null_else_second(cmd->parameter, svr->card);
            svr->param = sub_8144418(ptr, svr->mevent_unk1442cc, ptr);
            break;
        case 8:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 402, "cmd->flag == FALSE", 1);;
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 403, "cmd->parameter == NULL", 1);;
            svr->param = *(u32 *)svr->recvBuffer;
            break;
        case 9:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 408, "cmd->flag == FALSE", 1);;
            ...
            break;
        case 10:
            (cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 415, "cmd->parameter == NULL", 1);;
            svr->param = sub_81444B0(svr->mevent_unk1442cc, cmd->flag);
            break;
        case 11:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 420, "cmd->flag == FALSE", 1);;
            svr->param = sub_8144474(svr->mevent_unk1442cc, cmd->parameter);
            break;
        case 12:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 426, "cmd->flag == FALSE", 1);;
            svr->param = mevent_compare_pointers(cmd->parameter, *(void **)svr->recvBuffer);
            break;
        case 14:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 432, "cmd->flag == FALSE", 1);;
            ...
            break;
        case 13:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 438, "cmd->flag == FALSE", 1);;
            ...
            break;
        case 16:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 444, "cmd->flag == FALSE", 1);;
        ...
        case 18:
            ...
            break;
        case 19:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 466, "cmd->flag == FALSE", 1);;
        ...
        case 17:
            ...
            break;
        case 22:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 481, "cmd->flag == FALSE", 1);;
            memcpy(svr->card, cmd->parameter, 332);
            break;
        case 23:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 486, "cmd->flag == FALSE", 1);;
            memcpy(svr->news, cmd->parameter, 444);
            break;
        case 21:
            (cmd->flag == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 491, "cmd->flag == FALSE", 1);;
        ...
        case 25:
            ...
            break;
        case 26:
            (cmd->flag == 0 && cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 506, "cmd->flag == FALSE && cmd->parameter == NULL", 1);;
            memcpy(svr->card, GetSavedWonderCard(), 332);
            MEvent_WonderCardResetUnk08_6(svr->card);
            break;
        case 27:
            (cmd->flag == 0 && cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 512, "cmd->flag == FALSE && cmd->parameter == NULL", 1);;
            memcpy(svr->news, GetSavedWonderNews(), 444);
            break;
        case 28:
            (cmd->flag == 0 && cmd->parameter == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 517, "cmd->flag == FALSE && cmd->parameter == NULL", 1);;
...
{
    u32 response;
    (svr->mainseqno < (sizeof(func_tbl) / sizeof((func_tbl)[0]))) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 546, "svr->mainseqno < NELEMS(func_tbl)", 1);;
    response = func_tbl[svr->mainseqno](svr);
    (svr->mainseqno < (sizeof(func_tbl) / sizeof((func_tbl)[0]))) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), 548, "svr->mainseqno < NELEMS(func_tbl)", 1);;
    return response;
}
