...
static __attribute__((section("ewram_data"))) struct TradeAnimationResources * sTradeData = ((void *)0);
...
static const union AnimCmd gAnimCmd_826CED8[] = {
    {.frame = {0x00, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x20, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x40, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x60, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x40, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x20, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0x00, 2, .hFlip = 1, .vFlip = 1}},
    {.loop = {.type = -3, .count = 8}},
...
void CB2_InitTradeAnim_LinkTrade(void)
{
    ...
    case 10:
        ...
        ShowBg(0);
        sTradeData->monSpecies[0] = GetMonData(&gPlayerParty[gSelectedTradeMonPositions[0]], 65);
        sTradeData->monSpecies[1] = GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 65);
...
static void SetTradeSequenceBgGpuRegs(u8 state)
{
    ...
    case 2:
        ...
        if (!sTradeData->isCableTrade)
        {
            ...
            LZ77UnCompVram(sWirelessCloseupMap, (void *)(void *)(0x6000000 + (0x800 * (5))));
            BlendPalettes(0x000000008, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
        }
        else
        {
            SetGpuReg(0x0, 0x0001 | 0x0040 | 0x0200 | 0x1000);
            { const void *_src = sCableCloseupMap; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (5))); u32 _size = 0x800; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
    ...
    case 6:
        ...
        sTradeData->bg2alpha = 0;
        { const void *_src = sGbaAffineTiles; void *_dest = (void *)(0x6000000 + (0x4000 * (1))); u32 _size = 0x2840; while (1) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; _src += (0x1000); _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } } };
        if (sTradeData->isCableTrade)
        {
            { const void *_src = sGbaAffineMapCable; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
...
static bool8 DoTradeAnim_Cable(void)
{
    ...
    case 10:
        ...
        if (sTradeData->tradeSpecies[0] != 412)
        {
    ...
    case 63:
        ...
        BlendPalettes(1 << (16 + gSprites[sTradeData->pokeballSpriteId2].oam.paletteNum), 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeData->state++;
        sTradeData->timer = 0;
        break;
    case 64:
        BeginNormalPaletteFade(1 << (16 + gSprites[sTradeData->pokeballSpriteId2].oam.paletteNum), 1, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeData->state++;
        break;
    case 65:
    ...
    case 167:
        if (++sTradeData->timer > 60)
        {
            if (sTradeData->tradeSpecies[1] != 412)
            {
...
static void CreateInGameTradePokemonInternal(u8 playerSlot, u8 inGameTradeIdx)
{
    ...
    u8 mailNum;
    CreateMon(tradeMon, inGameTrade->species, level, 32, 1, inGameTrade->personality, 1, inGameTrade->otId);
...
static void CB2_HandleTradeEnded(void)
{
    ...
    case 50:
        if (InUnionRoom())
        {
            SetQuestLogEvent(18, sTradeData->monSpecies);
        }
        else
        {
            SetQuestLogEvent(12, sTradeData->monSpecies);
...
static void CheckPartnersMonForRibbons(void)
{
    ...
    for (i = 0; i < 12; i++)
    {
        nRibbons += GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 67 + i);
    }
    if (nRibbons != 0)
...
static void Task_OpenCenterWhiteColumn(u8 taskId)
{
    ...
    SetGpuReg(0x40, ((sTradeData->win0right) | ((sTradeData->win0left) << 8)));
    SetGpuReg(0x44, ((sTradeData->win0bottom) | ((sTradeData->win0top) << 8)));
