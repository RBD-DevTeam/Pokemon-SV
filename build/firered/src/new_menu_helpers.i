...
void AddTextPrinterDiffStyle(bool8 allowSkippingDelayWithButtonPress)
{
    ...
    if (color == 0)
        AddTextPrinterParameterized2(0, FONT_4, gStringVar4, GetTextSpeedSetting(), nptr, 0x8, 0x1, 0x3);
    else if (color == 1)
        AddTextPrinterParameterized2(0, FONT_5, gStringVar4, GetTextSpeedSetting(), nptr, 0x4, 0x1, 0x3);
    else
        AddTextPrinterParameterized2(0, FONT_2, gStringVar4, GetTextSpeedSetting(), nptr, 0x2, 0x1, 0x3);
}

void AddTextPrinterForMessage(bool8 allowSkippingDelayWithButtonPress)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, FONT_2, gStringVar4, GetTextSpeedSetting(), ((void *)0), 0x2, 0x1, 0x3);
}

void AddTextPrinterWithCustomSpeedForMessage(bool8 allowSkippingDelayWithButtonPress, u8 speed)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, FONT_2, gStringVar4, speed, ((void *)0), 0x2, 0x1, 0x3);
}
...
void LoadStdWindowFrameGfx(void)
{
    ...
    {
        Menu_LoadStdPal();
        LoadMenuMessageWindowGfx(0, 0x200, 15 * 0x10);
    }
    LoadUserWindowGfx(0, 0x214, 14 * 0x10);
}
...
void LoadMessageBoxAndFrameGfx(u8 windowId, bool8 copyToVram)
{
    ...
    {
        LoadMenuMessageWindowGfx(windowId, 0x200, 15 * 0x10);
    }
...
void Menu_LoadStdPal(void)
{
    LoadPalette(gStandardMenuPalette, 14 * 0x10, 0x14);
}
...
void DisplayYesNoMenuDefaultYes(void)
{
    CreateYesNoMenu(&sYesNo_WindowTemplate, FONT_2, 0, 2, 0x214, 14, 0);
}

void DisplayYesNoMenuDefaultNo(void)
{
    CreateYesNoMenu(&sYesNo_WindowTemplate, FONT_2, 0, 2, 0x214, 14, 1);
}
...
void DrawHelpMessageWindowWithText(const u8 * text)
{
    LoadHelpMessageWindowGfx(CreateHelpMessageWindow(), 0x200, 0x10 * 15);
...
{
    Menu_LoadStdPal();
    LoadSignpostWindowGfx(0, 0x200, 0x10 * 15);
    LoadUserWindowGfx(0, 0x214, 0x10 * 14);
}
