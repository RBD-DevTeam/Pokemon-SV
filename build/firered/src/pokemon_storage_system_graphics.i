...
# 717 "src/pokemon_storage_system_graphics.c"
...
# 770 "src/pokemon_storage_system_graphics.c"
void DestroyMovingMonIcon(void)
{
...
static void LoadWallpaperGfx(u8 boxId, s8 direction)
{
    ...
    if (gStorage->wallpaperLoadDir != 0)
        ...
        CpuSet(wallpaper->palettes, &gPlttBufferUnfaded[(gStorage->wallpaperOffset * 32) + 0x40], 0x00000000 | ((0x40)/(16/8) & 0x1FFFFF));
...
static void CycleBoxTitleColor(void)
{
    ...
    if (gStorage->boxTitleCycleId == 0)
        CpuSet(sBoxTitleColors[wallpaperId], gPlttBufferUnfaded + gStorage->boxTitlePalOffset, 0x00000000 | ((4)/(16/8) & 0x1FFFFF));
    else
        CpuSet(sBoxTitleColors[wallpaperId], gPlttBufferUnfaded + gStorage->boxTitleAltPalOffset, 0x00000000 | ((4)/(16/8) & 0x1FFFFF));
}

static s16 GetBoxTitleBaseX(const u8 *string)
{
    return 240 - 64 - GetStringWidth(FONT_1, string, 0) / 2;
}
