...
void CB2_InitTitleScreen(void)
{
    ...
    case 2:
        ...
        {
            BlendPalettes(0x0000FFFF, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
...
static void SetTitleScreenScene_FadeIn(s16 * data)
{
    ...
    case 1:
        ...
        if (data[2] > 10)
        {
            ...
            BeginNormalPaletteFade(0x00002000, 9, 0x10, 0, ((0) | ((0) << 5) | ((0) << 10)));
            data[1]++;
        }
        break;
    case 2:
    ...
    case 3:
        ...
        if (data[2] > 36)
        {
            ...
            BlendPalettesGradually(0x2000, -4, 0x01, 0x10, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[2] = 0;
            data[1]++;
        }
        break;
    case 4:
        ...
        {
            BlendPalettesGradually(0x2000, -4, 0x0F, 0x00, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 5:
    ...
    case 7:
        ...
        {
            data[2] = 0;
            BlendPalettesGradually(0x2000, -3, 0x00, 0x10, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 8:
        if (!IsBlendPalettesGraduallyTaskActive(0))
        {
            ...
            BlendPalettes(r4, 0x10, ((30) | ((30) << 5) | ((31) << 10)));
            BeginNormalPaletteFade(r4, 1, 0x10, 0x00, ((30) | ((30) << 5) | ((31) << 10)));
            ShowBg(0);
            CpuSet(gGraphics_TitleScreen_BoxArtMonPals, gPlttBufferUnfaded + 0xD0, 0x00000000 | ((0x20)/(16/8) & 0x1FFFFF));
            BlendPalettesGradually(0x2000, 1, 0x0F, 0x00, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 9:
...
static void SetTitleScreenScene_Cry(s16 * data)
{
    ...
    case 1:
        ...
        {
            BeginNormalPaletteFade(0x0FFFFFFF, 0, 0, 0x10, ((31) | ((31) << 5) | ((31) << 10)));
            SignalEndTitleScreenPaletteSomethingTask();
            FadeOutBGM(4);
            data[1]++;
        }
...
static void Task_TitleScreen_SlideWin0(u8 taskId)
{
    ...
    case 0:
        ...
        SetGpuReg(0x48, (((0x00) << 8) | (0x3F)));
        SetGpuReg(0x4a, (((0x00) << 8) | (0x37)));
        SetGpuReg(0x44, 0xA0);
        SetGpuReg(0x40, 0x00);
        BlendPalettes(0x00004000, 0, ((0) | ((0) << 5) | ((0) << 10)));
        data[0]++;
        break;
    case 1:
        data[1] += 0x180;
    ...
    case 2:
        ...
        break;
    case 3:
        SetGpuReg(0x4a, (((0) << 8) | (0x3B)));
        SetGpuReg(0x40, 0xF0F0);
        ChangeBgX(2, -0xF000, 0);
        BlendPalettes(0x00008000, 0, ((0) | ((0) << 5) | ((0) << 10)));
        data[1] = 0xF00;
        data[0]++;
        break;
    case 4:
