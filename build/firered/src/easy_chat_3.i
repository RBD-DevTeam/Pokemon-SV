...
static void PrintTitleText(void)
{
    ...
    EC_AddTextPrinterParameterized2(0, FONT_1, titleText, xOffset, 0, 0xFF, 0x0, 0x2, 0x3);
    PutWindowTilemap(0);
...
static void PrintECInterfaceTextById(u8 direction)
{
    ...
    if (text1)
        EC_AddTextPrinterParameterized(1, FONT_1, text1, 0, 0, 0xFF, ((void *)0));

    if (text2)
        EC_AddTextPrinterParameterized(1, FONT_1, text2, 0, 16, 0xFF, ((void *)0));
...
static void PrintECFields(void)
{
    ...
    for (i = 0; i < numRows; i++)
    {
        ...
        *str = 0xFF;
        EC_AddTextPrinterParameterized(sEasyChatGraphicsResources->windowId, FONT_1, sEasyChatGraphicsResources->ecPrintBuffer, 0, i * 16, 0xFF, ((void *)0));
    }
...
static void PrintECGroupsMenu(void)
{
    ...
    while (1)
    {
        for (x = 0; x < 2; x++)
        {
            ...
            EC_AddTextPrinterParameterized(2, FONT_1, GetEasyChatWordGroupName(groupId), x * 84 + 10, y, 0xFF, ((void *)0));
        }
...
static void PrintEasyChatKeyboardText(void)
{
    ...
    for (i = 0; i < (sizeof(sEasyChatKeyboardAlphabet) / sizeof((sEasyChatKeyboardAlphabet)[0])); i++)
        EC_AddTextPrinterParameterized(2, FONT_1, sEasyChatKeyboardAlphabet[i], 10, 96 + i * 16, 0xFF, ((void *)0));
}
    ...
    for (i = 0; i < remrow; i++)
    {
        for (j = 0; j < 2; j++)
        {
            ...
            if (easyChatWord != 0xFFFF)
            {
                ...
                EC_AddTextPrinterParameterized(2, FONT_1, sEasyChatGraphicsResources->ecPaddedWordBuffer, (j * 13 + 3) * 8, y_, 0xFF, ((void *)0));
            }
        }
        y += 16;
...
static void CreateFooterWindow(void)
{
    ...
    EC_AddTextPrinterParameterized(windowId, FONT_1, gText_DelAllCancelOk, 0, 0, 0, ((void *)0));
