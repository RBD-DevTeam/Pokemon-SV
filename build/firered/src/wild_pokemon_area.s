...
.text
	.align	2, 0
	.globl	BuildPokedexAreaSubspriteBuffer
	.type	 BuildPokedexAreaSubspriteBuffer,function
	.thumb_func
BuildPokedexAreaSubspriteBuffer:
	push	{r4, r5, r6, r7, lr}
	mov	r7, sl
	mov	r6, r9
	mov	r5, r8
...
.L9:
	add	r0, r4, #0
	ldr	r1, [sp, #0xc]
	bl	PokemonInAnyEncounterTableInMap
	add	r6, r6, #0x1
	str	r6, [sp, #0x20]
	cmp	r0, #0
	beq	.L7	@cond_branch
...
.L12:
	...
	mov	r2, #0x37
	add	r3, r6, #0
	bl	TryGetMapSecPokedexAreaEntry
	cmp	r0, #0
	bne	.L14	@cond_branch
	mov	r2, #0x0
	add	r5, sp, #0x4
...
.L34:
	...
	.word	gWildMonHeaders
.Lfe1:
	.size	 BuildPokedexAreaSubspriteBuffer,.Lfe1-BuildPokedexAreaSubspriteBuffer
	.align	2, 0
...
.Lfe2:
	...
	.align	2, 0
	.type	 CountRoamerNests,function
	.thumb_func
CountRoamerNests:
	push	{r4, r5, lr}
	add	sp, sp, #-0xc
...
.L51:
	...
	bx	r1
.Lfe3:
	.size	 CountRoamerNests,.Lfe3-CountRoamerNests
	.align	2, 0
	.type	 PokemonInAnyEncounterTableInMap,function
	.thumb_func
PokemonInAnyEncounterTableInMap:
	push	{r4, r5, lr}
	add	r4, r0, #0
	add	r5, r1, #0
	ldr	r0, [r4, #0x4]
	mov	r2, #0xc
	bl	PokemonInEncounterTable
	cmp	r0, #0
	bne	.L58	@cond_branch
	ldr	r0, [r4, #0x8]
	add	r1, r5, #0
...
.L59:
	...
	bx	r1
.Lfe4:
	.size	 PokemonInAnyEncounterTableInMap,.Lfe4-PokemonInAnyEncounterTableInMap
	.align	2, 0
	.type	 PokemonInEncounterTable,function
	.thumb_func
PokemonInEncounterTable:
	push	{r4, lr}
	add	r4, r1, #0
	cmp	r0, #0
	beq	.L61	@cond_branch
...
.L68:
	...
	bx	r1
.Lfe5:
	.size	 PokemonInEncounterTable,.Lfe5-PokemonInEncounterTable
	.align	2, 0
...
.Lfe6:
	...
	.align	2, 0
	.type	 TryGetMapSecPokedexAreaEntry,function
	.thumb_func
TryGetMapSecPokedexAreaEntry:
	push	{r4, r5, r6, lr}
	add	r4, r2, #0
	ldr	r6, [sp, #0x10]
	lsl	r0, r0, #0x10
...
.L77:
	...
	bx	r1
.Lfe7:
	.size	 TryGetMapSecPokedexAreaEntry,.Lfe7-TryGetMapSecPokedexAreaEntry
.text
