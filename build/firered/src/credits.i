...
static bool32 DoOverworldMapScrollScene(u8 whichMon)
{
    ...
    case 1:
        ...
        CreateCreditsWindow();
        SetGpuReg(0x40, 0xF0);
        SetGpuReg(0x44, 0x247C);
        SwitchWin1OffWin0On();
        InitBgDarkenEffect();
        Menu_LoadStdPalAt(0xF0);
        gPlttBufferUnfaded[0xFF] = ((0) | ((0) << 5) | ((0) << 10));
        gPlttBufferFaded[0xFF] = ((0) | ((0) << 5) | ((0) << 10));
        return 1;
    default:
        return 0;
    }
...
static bool32 DoCreditsMonScene(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        FillBgTilemapBufferRect(0, 0, 0, 0, 32, 32, ((1) | ((1) << 4)));
        PutWindowTilemap(0);
