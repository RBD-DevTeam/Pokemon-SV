...
{
    u8 t = 0xFF;
    AddTextPrinterParameterized(0, FONT_2, &t, 0, 1, 0, ((void *)0));
    PicboxCancel();
}
...
void DrawElevatorCurrentFloorWindow(void)
{
    ...
    if (QuestLog_SchedulePlaybackCB(QLPlaybackCB_DestroyScriptMenuMonPicSprites) != 1)
    {
        ...
        DrawStdFrameWithCustomTileAndPalette(sElevatorCurrentFloorWindowId, 0, 0x21D, 0xD);
        AddTextPrinterParameterized(sElevatorCurrentFloorWindowId, FONT_2, gText_NowOn, 0, 2, 0xFF, ((void *)0));
        floorname = sFloorNamePointers[gSpecialVar_0x8005];
        strwidth = GetStringWidth(FONT_2, floorname, 0);
        AddTextPrinterParameterized(sElevatorCurrentFloorWindowId, FONT_2, floorname, 56 - strwidth, 16, 0xFF, ((void *)0));
...
void QuestLog_TryRecordDepartedLocation(void)
{
    ...
    if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x8)))
    {
        if (ql_entrance_id == 5)
        {
            if (gSaveBlock1Ptr->location.mapGroup == ((0 | (15 << 8)) >> 8) && (gSaveBlock1Ptr->location.mapNum == ((0 | (15 << 8)) & 0xFF) || gSaveBlock1Ptr->location.mapNum == ((3 | (15 << 8)) & 0xFF)))
            {
