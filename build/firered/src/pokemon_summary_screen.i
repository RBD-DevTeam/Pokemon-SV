...
# 628 "src/pokemon_summary_screen.c" 2
...
# 714 "src/pokemon_summary_screen.c"
...
# 977 "src/pokemon_summary_screen.c"
...
static void PokeSum_PrintPageName(const u8 * str)
{
    ...
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[0], FONT_2, 4, 1, sLevelNickTextColors[1], 0, str);
...
static void PrintMonLevelNickOnWindow2(const u8 * str)
{
    ...
    if (!sMonSummaryScreen->isEgg)
    {
        ...
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[2], FONT_2, 40, 2, sLevelNickTextColors[1], 0xFF, sMonSummaryScreen->summary.nicknameStrBuf);

        if (GetMonGender(&sMonSummaryScreen->currentMon) == 0xFE)
            AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[2], FONT_2, 105, 2, sLevelNickTextColors[3], 0, sMonSummaryScreen->summary.genderSymbolStrBuf);
        else
            AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[2], FONT_2, 105, 2, sLevelNickTextColors[2], 0, sMonSummaryScreen->summary.genderSymbolStrBuf);
    }
...
static void PrintInfoPage(void)
{
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 47, 19, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.speciesNameStrBuf);

    if (!sMonSummaryScreen->isEgg)
    {
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 47 + sMonSkillsPrinterXpos->unk00, 5, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.dexNumStrBuf);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 47, 49, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.otNameStrBuf);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 47, 64, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.unk306C);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 47, 79, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.itemNameStrBuf);
    }
    else
    {
        u8 eggCycles;
        ...
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 7, 45, sLevelNickTextColors[0], 0xFF, sEggHatchTimeTexts[hatchMsgIndex]);
    }
}

static void PrintSkillsPage(void)
{
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 14 + sMonSkillsPrinterXpos->curHpStr, 4, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.curHpStrBuf);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 50 + sMonSkillsPrinterXpos->atkStr, 22, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.statValueStrBufs[PSS_STAT_ATK]);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 50 + sMonSkillsPrinterXpos->defStr, 35, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.statValueStrBufs[PSS_STAT_DEF]);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 50 + sMonSkillsPrinterXpos->spAStr, 48, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.statValueStrBufs[PSS_STAT_SPA]);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 50 + sMonSkillsPrinterXpos->spDStr, 61, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.statValueStrBufs[PSS_STAT_SPD]);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 50 + sMonSkillsPrinterXpos->speStr, 74, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.statValueStrBufs[PSS_STAT_SPE]);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 15 + sMonSkillsPrinterXpos->expStr, 87, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.expPointsStrBuf);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 15 + sMonSkillsPrinterXpos->toNextLevel, 100, sLevelNickTextColors[0], 0xFF, sMonSummaryScreen->summary.expToNextLevelStrBuf);
}
...
static void PrintMovesPage(void)
{
    ...
    if (sMonSummaryScreen->curPageIndex == PSS_PAGE_MOVES_INFO)
    {
        if (sMonSummaryScreen->mode == PSS_MODE_SELECT_MOVE)
            ...
            AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2,
                                         3, ((4) * 28 + 5),
...
static void PokeSum_PrintMoveName(u8 i)
{
    ...
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 3, ((i) * 28 + 5), sPrintMoveTextColors[0], 0xFF, sMonSummaryScreen->summary.moveNameStrBufs[i]);
    ...
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 36, ((i) * 28 + 16), sPrintMoveTextColors[colorIdx], 0xFF,
        gText_PokeSum_PP);
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 46 + sMonSkillsPrinterXpos->curPp[i], ((i) * 28 + 16), sPrintMoveTextColors[colorIdx], 0xFF, sMonSummaryScreen->summary.moveCurPpStrBufs[i]);

    if (sMonSummaryScreen->moveIds[i] != 0)
    {
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 58, ((i) * 28 + 16), sPrintMoveTextColors[colorIdx], 0xFF, gText_Slash);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[3], FONT_2, 64 + sMonSkillsPrinterXpos->maxPp[i], ((i) * 28 + 16), sPrintMoveTextColors[colorIdx], 0xFF, sMonSummaryScreen->summary.moveMaxPpStrBufs[i]);
    }
}
...
static void PokeSum_PrintTrainerMemo_Mon_HeldByOT(void)
{
    ...
    AddTextPrinterParameterized4(sMonSummaryScreen->windowIds[4], FONT_2, 0, 3, 0, 0, sLevelNickTextColors[0], 0xFF, natureMetOrHatchedAtLevelStr);
}
...
static void PokeSum_PrintTrainerMemo_Egg(void)
{
    ...
    AddTextPrinterParameterized4(sMonSummaryScreen->windowIds[4], FONT_2, 0, 3, 0, 0, sLevelNickTextColors[0], 0xFF, sEggOriginTexts[chosenStrIndex]);
}

static void PokeSum_PrintExpPoints_NextLv(void)
{
    AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[4], FONT_2,
                                 26, 7,
...
static void PokeSum_PrintSelectedMoveStats(void)
{
    if (sMoveSelectionCursorPos < 5)
    {
        ...
        AddTextPrinterParameterized4(sMonSummaryScreen->windowIds[4], FONT_2,
                                     7, 42,
                                     0, 0,
                                     sLevelNickTextColors[0], 0xFF,
...
static void PokeSum_DrawMoveTypeIcons(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        BlitMoveInfoIcon(sMonSummaryScreen->windowIds[5], sMonSummaryScreen->moveTypes[i] + 1, 3, ((i) * 28 + 5));
    }

    if (sMonSummaryScreen->mode == PSS_MODE_SELECT_MOVE)
        BlitMoveInfoIcon(sMonSummaryScreen->windowIds[5], sMonSummaryScreen->moveTypes[4] + 1, 3, ((4) * 28 + 5));
}
...
static void PokeSum_PrintMonTypeIcons(void)
{
    ...
    case PSS_PAGE_INFO:
        if (!sMonSummaryScreen->isEgg)
        {
            BlitMoveInfoIcon(sMonSummaryScreen->windowIds[3], sMonSummaryScreen->monTypes[0] + 1, 47, 35);

            if (sMonSummaryScreen->monTypes[0] != sMonSummaryScreen->monTypes[1])
                BlitMoveInfoIcon(sMonSummaryScreen->windowIds[3], sMonSummaryScreen->monTypes[1] + 1, 83, 35);
        }
        break;
    case PSS_PAGE_SKILLS:
        break;
...
static void Task_HandleInput_SelectMove(u8 taskId)
{
    ...
    {
    case 0:
        if (MenuHelpers_CallLinkSomething() == 1 || IsLinkRecvQueueAtOverworldMax() == 1)
            return;
