...
const struct mevent_client_cmd gMEventClientScript_InitialListen[] = {
    {.instr = 2, .parameter = 0x10},
    {.instr = 4, .parameter = 0}
};
...
const struct mevent_client_cmd gMEventClientScript_UnableToRecv[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x0a}
};

const struct mevent_client_cmd gMEventClientScript_CommError[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x0b}
};

const struct mevent_client_cmd gMEventClientScript_NothingSentOver[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x00}
};

const struct mevent_client_cmd gMEventClientScript_ReceiveCardAndReturnSuccess[] = {
    {.instr = 2, .parameter = 0x16},
    {.instr = 10, .parameter = 0},
    {.instr = 2, .parameter = 0x19},
    {.instr = 17, .parameter = 0},
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x02}
};

const struct mevent_client_cmd gMEventClientScript_ReceiveNewsAndValidate[] = {
    {.instr = 2, .parameter = 0x17},
    {.instr = 9, .parameter = 0},
    {.instr = 3, .parameter = 0},
    {.instr = 2, .parameter = 0x10},
    {.instr = 4, .parameter = 0}
...
const struct mevent_client_cmd gMEventClientScript_AlreadyHadNews[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x07}
};

const struct mevent_client_cmd gMEventClientScript_RecvNewsSuccess[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x03}
};
...
const struct mevent_client_cmd gMEventClientScript_OtherTrainerCanceled[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x09}
};

const struct mevent_client_cmd gMEventClientScript_AlreadyHadCard[] = {
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x05}
};

const struct mevent_client_cmd gMEventClientScript_SuccessFromBuffer[] = {
    {.instr = 2, .parameter = 0x15},
    {.instr = 12, .parameter = 0},
    {.instr = 20, .parameter = 0},
    {.instr = 1, .parameter = 0x0d}
};



const struct mevent_server_cmd gMEventSrvScript_UnableToSend[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_UnableToRecv},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x0a}
};
...
const struct mevent_server_cmd gUnknown_8468950[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_CommError},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x0b}
};
...
const struct mevent_server_cmd gUnknown_8468980[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_OtherTrainerCanceled},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x09}
};
...
const struct mevent_server_cmd gMEventSrvScript_OtherTrnHasNews[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_AlreadyHadNews},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x07}
};
...
const struct mevent_server_cmd gMEventSrvScript_SentNewsSuccess[] = {
    {.instr = 18, .flag = 0x28, .parameter = (void *)gMEventClientScript_ReceiveNewsAndValidate},
    {.instr = 1},
    {.instr = 14},
    {.instr = 1},
    {.instr = 2, .flag = 0x13},
    {.instr = 8},
    {.instr = 4, .flag = 0x01, .parameter = (void *)gMEventSrvScript_OtherTrnHasNews},
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_RecvNewsSuccess},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x03}
};
...
const struct mevent_server_cmd gMEventSrvScript_SendCardSuccess[] = {
    {.instr = 18, .flag = 0x30, .parameter = (void *)gMEventClientScript_ReceiveCardAndReturnSuccess},
    {.instr = 1},
    {.instr = 13},
    {.instr = 1},
    {.instr = 15},
...
const struct mevent_server_cmd gMEventSrvScript_AskClientToOverwriteCard[] = {
    {.instr = 18, .flag = 0x28, .parameter = (void *)gMEventClientScript_AskWouldLikeToTossCard},
    {.instr = 1},
    {.instr = 2, .flag = 0x13},
    {.instr = 8},
    {.instr = 4, .flag = 0x00, .parameter = (void *)gMEventSrvScript_SendCardSuccess},
    {.instr = 3, .parameter = (void *)gServerScript_ClientCanceledCard}
};

const struct mevent_server_cmd gMEventSrvScript_OtherTrnHasCard[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_AlreadyHadCard},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x05}
};
...
const struct mevent_server_cmd gUnknown_8468B3C[] = {
    {.instr = 18, .flag = 0x10, .parameter = (void *)gMEventClientScript_NothingSentOver},
    {.instr = 1},
    {.instr = 2, .flag = 0x14},
    {.instr = 0, .flag = 0x00}
};
...
const struct mevent_server_cmd gMEventSrvScript_SendNews[] = {
    {.instr = 27},
    {.instr = 18, .flag = 0x20, .parameter = (void *)gMEventClientScript_Send1442CC},
    {.instr = 1},
    {.instr = 2, .flag = 0x11},
    {.instr = 5},
    {.instr = 6},
    {.instr = 4, .flag = 0x00, .parameter = (void *)gMEventSrvScript_UnableToSend},
    {.instr = 3, .parameter = (void *)gMEventSrvScript_SentNewsSuccess}
};
...
const struct mevent_server_cmd gMEventSrvScript_SendCard[] = {
    ...
    {.instr = 4, .flag = 0x00, .parameter = (void *)gMEventSrvScript_UnableToSend},
    {.instr = 7},
    {.instr = 4, .flag = 0x02, .parameter = (void *)gMEventSrvScript_AskClientToOverwriteCard},
    {.instr = 4, .flag = 0x00, .parameter = (void *)gMEventSrvScript_SendCardSuccess},
    {.instr = 3, .parameter = (void *)gMEventSrvScript_OtherTrnHasCard}
};
