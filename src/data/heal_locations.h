...
{
    [SPAWN_PALLET_TOWN - 1] = {MAP_GROUP(PALLET_TOWN), MAP_NUM(PALLET_TOWN), 30, 9},
    ...
    [SPAWN_POCO_PATH - 1] = {MAP_GROUP(POCO_PATH), MAP_NUM(POCO_PATH), 21, 18},
    [SPAWN_NEW_MAP1 - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 10, 10},
    [SPAWN_PRINCIPALS_HOUSE - 1] = {MAP_GROUP(PRINCIPALS_HOUSE), MAP_NUM(PRINCIPALS_HOUSE), 10, 10},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_POCO_PATH - 1] = {MAP_GROUP(POCO_PATH), MAP_NUM(POCO_PATH)},
    [SPAWN_NEW_MAP1 - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1)},
    [SPAWN_PRINCIPALS_HOUSE - 1] = {MAP_GROUP(PRINCIPALS_HOUSE), MAP_NUM(PRINCIPALS_HOUSE)},
};
