...
__attribute__((section("ewram_data"))) struct OakSpeechResources * sOakSpeechResources = ((void *)0);
...
__attribute__((aligned(4))) static const u16 sHelpDocsPalette[] = INCBIN_U16("graphics/oak_speech/help_docs_palette.gbapal");
...
static const struct SpriteTemplate sOakSpeech_GrassPlatformSpriteTemplates[3] = {
    { 0x1000, 0x1000, &gOamData_AffineOff_ObjBlend_32x32, sGrassPlatformAnims1, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy },
    { 0x1000, 0x1000, &gOamData_AffineOff_ObjBlend_32x32, sGrassPlatformAnims2, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy },
    { 0x1000, 0x1000, &gOamData_AffineOff_ObjBlend_32x32, sGrassPlatformAnims3, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy },
};
...
static const struct SpriteTemplate sOakSpeech_PikaSpriteTemplates[3] = {
    { 0x1001, 0x1001, &gOamData_AffineOff_ObjNormal_32x32, sPikaAnims1, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy },
    { 0x1002, 0x1001, &gOamData_AffineOff_ObjNormal_32x16, sPikaAnims2, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy },
    { 0x1003, 0x1001, &gOamData_AffineOff_ObjNormal_16x8, sPikaAnims3, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy }
};
...
static void Task_OaksSpeech1(u8 taskId)
{
    ...
    case 0:
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x5000000 + sizeof(u16)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x400 - 2)/(16/8))); dmaRegs[2]; }; };
        ResetPaletteFade();
        ScanlineEffect_Stop();
        ResetSpriteData();
...
static void Task_OaksSpeech2(u8 taskId)
{
    if (!gPaletteFade.active && ({(gMain.newKeys) & ((0x0001 | 0x0002));}))
    {
...
static void Task_OakSpeech5(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        sOakSpeechResources->unk_0014[0] = ((0) | ((0) << 5) | ((0) << 10));
...
static void Task_OakSpeech6(u8 taskId)
{
    ...
    else
    {
        ...
        sOakSpeechResources->unk_0008 = ((void *)0);
...
static void Task_OakSpeech7(u8 taskId)
{
    ...
    case 0:
        if (!gPaletteFade.active)
        {
            ...
            SetGpuReg(0x44, 0x10A0);
            SetGpuReg(0x48, 0x003F);
            SetGpuReg(0x4a, 0x001F);
...
static void Task_OakSpeech10(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        {
            ({ DrawDialogueFrame(0, 0); if (gOakText_WelcomeToTheWorld != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_WelcomeToTheWorld); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_WelcomeToTheWorld, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech11(u8 taskId)
{
    ...
    {
        ({ DrawDialogueFrame(0, 0); if (gOakText_WorldInhabited1 != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_WorldInhabited1); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_WorldInhabited1, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech13(u8 taskId)
{
    ...
    if (gTasks[taskId].data[3] < 0x4000)
    {
        ...
        {
            ({ DrawDialogueFrame(0, 0); if (gOakText_WorldInhabited2 != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_WorldInhabited2); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_WorldInhabited2, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
            PlayCry_Normal(29, 0);
        }
    }
}
...
static void Task_OakSpeech14(u8 taskId)
{
    if (!IsTextPrinterActive(0))
    {
        ({ DrawDialogueFrame(0, 0); if (gOakText_PetsBattlingStudy != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_PetsBattlingStudy); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_PetsBattlingStudy, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech16(u8 taskId)
{
    ...
    else
    {
        ...
        {
            ({ DrawDialogueFrame(0, 0); if (gOakText_TellMeALittleAboutYourself != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_TellMeALittleAboutYourself); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_TellMeALittleAboutYourself, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech18(u8 taskId)
{
    ...
    if (data[2] != 0)
    {
        ...
        else
        {
            ...
            ({ DrawDialogueFrame(0, 0); if (gOakText_AskPlayerGender != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_AskPlayerGender); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_AskPlayerGender, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech23(u8 taskId)
{
    ...
    if (data[2] != 0)
    {
        ...
        {
            data[1] = 0;
            ({ DrawDialogueFrame(0, 0); if (gOakText_AskPlayerName != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_AskPlayerName); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_AskPlayerName, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech28(u8 taskId)
{
    ...
    {
        ({ DrawDialogueFrame(0, 0); if (gOakText_AskPlayerName != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_AskPlayerName); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, 0, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_AskPlayerName, 0, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
    }
    else
    {
        ({ DrawDialogueFrame(0, 0); if (gOakText_AskRivalName != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_AskRivalName); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, 0, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_AskRivalName, 0, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
    }
    gTasks[taskId].func = Task_OakSpeech29;
}
...
static void Task_OakSpeech26(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        if (data[15] == 1)
        {
            ...
            ({ DrawDialogueFrame(0, 0); if (gStringVar4 != gStringVar4) { StringExpandPlaceholders(gStringVar4, gStringVar4); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
            data[15] = 0;
            data[3] = 25;
        }
...
static void Task_OakSpeech34(u8 taskId)
{
    ...
    if (data[2] != 0)
    {
        ({ DrawDialogueFrame(0, 0); if (gOakText_IntroduceRival != gStringVar4) { StringExpandPlaceholders(gStringVar4, gOakText_IntroduceRival); AddTextPrinterParameterized2(0, FONT_4, gStringVar4, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } else { AddTextPrinterParameterized2(0, FONT_4, gOakText_IntroduceRival, sOakSpeechResources->textSpeed, ((void *)0), 0x2, 0x1, 0x3); } CopyWindowToVram(0, COPYWIN_FULL); });
...
static void Task_OakSpeech38_1(u8 taskId)
{
    ...
    data[2] = 0;
    data[15] = 0;
    BeginNormalPaletteFade(0xFFFF0FCF, 4, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
}
...
static void Task_OakSpeech38_sub1(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        {
            data[1]++;
            BeginNormalPaletteFade(0x0000F000, 0, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
        }
    }
}
...
static void Task_OakSpeech38_sub2(u8 taskId)
{
    ...
    else
    {
        if (data[1] <= 0 && data[2] != 0)
            data[2]--;
        BlendPalette(0x40, 0x20, data[14], ((31) | ((31) << 5) | ((31) << 10)));
        data[14]++;
        data[1]--;
        data[0] = data[2];
        if (data[14] > 14)
        {
            for (i = 0; i < 32; i++)
            {
                gPlttBufferFaded[i + 0x40] = ((31) | ((31) << 5) | ((31) << 10));
                gPlttBufferUnfaded[i + 0x40] = ((31) | ((31) << 5) | ((31) << 10));
            }
            DestroyTask(taskId);
        }
    }
...
static void Task_OakSpeech40(u8 taskId)
{
    ...
    {
        BeginNormalPaletteFade(0x00000030, 2, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
...
static void CB2_ReturnFromNamingScreen(void)
{
    ...
    case 0:
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x6000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x18000)/(16/8))); dmaRegs[2]; }; };
        { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x7000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x400)/(32/8))); dmaRegs[2]; }; };
        { vu16 tmp = (vu16)(((0) | ((0) << 5) | ((0) << 10))); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x5000000 + sizeof(u16)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x400 - sizeof(u16))/(16/8))); dmaRegs[2]; }; };
        ResetPaletteFade();
        ScanlineEffect_Stop();
        ResetSpriteData();
        FreeAllSpritePalettes();
...
static void CreateNidoranFSprite(u8 taskId)
{
    ...
    DecompressPicFromTable(&gMonFrontPicTable[29], OakSpeechNidoranFGetBuffer(0), 29);
...
static void PrintNameChoiceOptions(u8 taskId, u8 hasPlayerBeenNamed)
{
    ...
    FillWindowPixelBuffer(gTasks[taskId].data[13], 0x11);
    AddTextPrinterParameterized(data[13], FONT_2, gOtherText_NewName, 8, 1, 0, ((void *)0));
    ...
    for (i = 0; i < 4; i++)
    {
        AddTextPrinterParameterized(data[13], FONT_2, textPtrs[i], 8, 16 * (i + 1) + 1, 0, ((void *)0));
    }
