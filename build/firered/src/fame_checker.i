...
static void MessageBoxPrintEmptyText(void)
{
    AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_2, gFameCheckerText_ClearTextbox, 0, ((void *)0), 0x2, 0x1, 0x3);
}
...
static void GetPickModeText(void)
{
    ...
    else
    {
        ...
        AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_2, gStringVar4, GetTextSpeedSetting(), ((void *)0), 0x2, 0x1, 0x3);
...
{
    FillWindowPixelRect(FCWINDOWID_MSGBOX, ((1) | ((1) << 4)), 0, 0, 0xd0, 0x20);
    AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_2, gFameCheckerText_FameCheckerWillBeClosed, 0, ((void *)0), 0x2, 0x1, 0x3);
    FC_PutWindowTilemapAndCopyWindowToVramMode3(FCWINDOWID_MSGBOX);
}
