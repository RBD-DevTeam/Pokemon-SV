...
static void DrawNormalTextEntryBox(void)
{
    ...
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], FONT_1, sNamingScreen->template->title, 1, 1, 0, ((void *)0));
...
static void DrawMonTextEntryBox(void)
{
    ...
    FillWindowPixelBuffer(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], ((1) | ((1) << 4)));
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], FONT_1, buffer, 1, 1, 0, ((void *)0));
    PutWindowTilemap(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX]);
}
...
static void DrawGenderIcon(void)
{
    ...
    if (sNamingScreen->monGender != 0xFF)
    {
        ...
        AddTextPrinterParameterized3(sNamingScreen->windows[2], FONT_2, 0x68, 1, sGenderColors[gender], 0xFF, genderSymbol);
    }
}
...
static void DrawTextEntry(void)
{
    ...
    for (i = 0; i < maxChars; i++)
    {
        ...
        AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY], FONT_2, temp, i * 8 + xpos + extraWidth, 1, 0xFF, ((void *)0));
    }
...
static void PrintControls(void)
{
    ...
    AddTextPrinterParameterized3(sNamingScreen->windows[WIN_BANNER], FONT_0, 240 - 4 - strwidth, 0, color, 0, gText_MoveOkBack);
