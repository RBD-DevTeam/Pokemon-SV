...
static const struct HealLocation sSpawnPoints[] =
{
    ...
    [22 - 1] = {((67 | (3 << 8)) >> 8), ((67 | (3 << 8)) & 0xFF), 10, 10},
    [23 - 1] = {((68 | (3 << 8)) >> 8), ((68 | (3 << 8)) & 0xFF), 10, 10},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [21 - 1] = {((66 | (3 << 8)) >> 8), ((66 | (3 << 8)) & 0xFF)},
    [22 - 1] = {((67 | (3 << 8)) >> 8), ((67 | (3 << 8)) & 0xFF)},
    [23 - 1] = {((68 | (3 << 8)) >> 8), ((68 | (3 << 8)) & 0xFF)},
};
