...
const struct MultichoiceListStruct gScriptMultiChoiceMenus[] = {
    { sScriptMultiChoiceMenu_YesNo, (sizeof(sScriptMultiChoiceMenu_YesNo) / sizeof((sScriptMultiChoiceMenu_YesNo)[0])) },
    { sScriptMultiChoiceMenu_Eeveelutions, (sizeof(sScriptMultiChoiceMenu_Eeveelutions) / sizeof((sScriptMultiChoiceMenu_Eeveelutions)[0])) },
    { sScriptMultiChoiceMenu_TrainerCardIconTint, (sizeof(sScriptMultiChoiceMenu_TrainerCardIconTint) / sizeof((sScriptMultiChoiceMenu_TrainerCardIconTint)[0])) },
    { sScriptMultiChoiceMenu_HOF_Quit, (sizeof(sScriptMultiChoiceMenu_HOF_Quit) / sizeof((sScriptMultiChoiceMenu_HOF_Quit)[0])) },
    { sScriptMultiChoiceMenu_Eggs_Quit, (sizeof(sScriptMultiChoiceMenu_Eggs_Quit) / sizeof((sScriptMultiChoiceMenu_Eggs_Quit)[0])) },
    { sScriptMultiChoiceMenu_Victories_Quit, (sizeof(sScriptMultiChoiceMenu_Victories_Quit) / sizeof((sScriptMultiChoiceMenu_Victories_Quit)[0])) },
    { sScriptMultiChoiceMenu_HOF_Eggs_Quit, (sizeof(sScriptMultiChoiceMenu_HOF_Eggs_Quit) / sizeof((sScriptMultiChoiceMenu_HOF_Eggs_Quit)[0])) },
    { sScriptMultiChoiceMenu_HOF_Victories_Quit, (sizeof(sScriptMultiChoiceMenu_HOF_Victories_Quit) / sizeof((sScriptMultiChoiceMenu_HOF_Victories_Quit)[0])) },
    { sScriptMultiChoiceMenu_Eggs_Victories_Quit, (sizeof(sScriptMultiChoiceMenu_Eggs_Victories_Quit) / sizeof((sScriptMultiChoiceMenu_Eggs_Victories_Quit)[0])) },
    { sScriptMultiChoiceMenu_HOF_Eggs_Victories_Quit, (sizeof(sScriptMultiChoiceMenu_HOF_Eggs_Victories_Quit) / sizeof((sScriptMultiChoiceMenu_HOF_Eggs_Victories_Quit)[0])) },
    { sScriptMultiChoiceMenu_Exit, (sizeof(sScriptMultiChoiceMenu_Exit) / sizeof((sScriptMultiChoiceMenu_Exit)[0])) },
    { sScriptMultiChoiceMenu_Exit, (sizeof(sScriptMultiChoiceMenu_Exit) / sizeof((sScriptMultiChoiceMenu_Exit)[0])) },
    { sScriptMultiChoiceMenu_Exit, (sizeof(sScriptMultiChoiceMenu_Exit) / sizeof((sScriptMultiChoiceMenu_Exit)[0])) },
    { sScriptMultiChoiceMenu_BikeShop, (sizeof(sScriptMultiChoiceMenu_BikeShop) / sizeof((sScriptMultiChoiceMenu_BikeShop)[0])) },
    { sScriptMultiChoiceMenu_GameCornerPokemonPrizes, (sizeof(sScriptMultiChoiceMenu_GameCornerPokemonPrizes) / sizeof((sScriptMultiChoiceMenu_GameCornerPokemonPrizes)[0])) },
    { sScriptMultiChoiceMenu_TrainerSchoolWhiteboard, (sizeof(sScriptMultiChoiceMenu_TrainerSchoolWhiteboard) / sizeof((sScriptMultiChoiceMenu_TrainerSchoolWhiteboard)[0])) },
    { sScriptMultiChoiceMenu_YesNoInfo, (sizeof(sScriptMultiChoiceMenu_YesNoInfo) / sizeof((sScriptMultiChoiceMenu_YesNoInfo)[0])) },
    { sScriptMultiChoiceMenu_SingleDoubleMultiInfoExit, (sizeof(sScriptMultiChoiceMenu_SingleDoubleMultiInfoExit) / sizeof((sScriptMultiChoiceMenu_SingleDoubleMultiInfoExit)[0])) },
    { sScriptMultiChoiceMenu_YesNoInfo2, (sizeof(sScriptMultiChoiceMenu_YesNoInfo2) / sizeof((sScriptMultiChoiceMenu_YesNoInfo2)[0])) },
    { sScriptMultiChoiceMenu_ChallengeInfoExit, (sizeof(sScriptMultiChoiceMenu_ChallengeInfoExit) / sizeof((sScriptMultiChoiceMenu_ChallengeInfoExit)[0])) },
    { sScriptMultiChoiceMenu_RooftopB1F, (sizeof(sScriptMultiChoiceMenu_RooftopB1F) / sizeof((sScriptMultiChoiceMenu_RooftopB1F)[0])) },
    { sScriptMultiChoiceMenu_Helix, (sizeof(sScriptMultiChoiceMenu_Helix) / sizeof((sScriptMultiChoiceMenu_Helix)[0])) },
    { sScriptMultiChoiceMenu_Dome, (sizeof(sScriptMultiChoiceMenu_Dome) / sizeof((sScriptMultiChoiceMenu_Dome)[0])) },
    { sScriptMultiChoiceMenu_Amber, (sizeof(sScriptMultiChoiceMenu_Amber) / sizeof((sScriptMultiChoiceMenu_Amber)[0])) },
    { sScriptMultiChoiceMenu_HelixAmber, (sizeof(sScriptMultiChoiceMenu_HelixAmber) / sizeof((sScriptMultiChoiceMenu_HelixAmber)[0])) },
    { sScriptMultiChoiceMenu_DomeAmber, (sizeof(sScriptMultiChoiceMenu_DomeAmber) / sizeof((sScriptMultiChoiceMenu_DomeAmber)[0])) },
    { sScriptMultiChoiceMenu_CeladonVendingMachine, (sizeof(sScriptMultiChoiceMenu_CeladonVendingMachine) / sizeof((sScriptMultiChoiceMenu_CeladonVendingMachine)[0])) },
    { sScriptMultiChoiceMenu_GameCornerCoinPurchaseCounter, (sizeof(sScriptMultiChoiceMenu_GameCornerCoinPurchaseCounter) / sizeof((sScriptMultiChoiceMenu_GameCornerCoinPurchaseCounter)[0])) },
    { sScriptMultiChoiceMenu_Excellent_NotSoBad, (sizeof(sScriptMultiChoiceMenu_Excellent_NotSoBad) / sizeof((sScriptMultiChoiceMenu_Excellent_NotSoBad)[0])) },
    { sScriptMultiChoiceMenu_RightLeft, (sizeof(sScriptMultiChoiceMenu_RightLeft) / sizeof((sScriptMultiChoiceMenu_RightLeft)[0])) },
    { sScriptMultiChoiceMenu_GameCornerTMPrizes, (sizeof(sScriptMultiChoiceMenu_GameCornerTMPrizes) / sizeof((sScriptMultiChoiceMenu_GameCornerTMPrizes)[0])) },
    { sScriptMultiChoiceMenu_DeptStoreElevator, (sizeof(sScriptMultiChoiceMenu_DeptStoreElevator) / sizeof((sScriptMultiChoiceMenu_DeptStoreElevator)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlFreshWater, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlFreshWater) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlFreshWater)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlSodaPop, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlSodaPop) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlSodaPop)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPop, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPop) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPop)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlLemonade, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlLemonade) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlLemonade)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlFreshWaterLemonade, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlFreshWaterLemonade) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlFreshWaterLemonade)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlSodaPopLemonade, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlSodaPopLemonade) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlSodaPopLemonade)[0])) },
    { sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPopLemonade, (sizeof(sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPopLemonade) / sizeof((sScriptMultiChoiceMenu_ThirstyGirlFreshWaterSodaPopLemonade)[0])) },
    { sScriptMultiChoiceMenu_TradeCenter_Colosseum, (sizeof(sScriptMultiChoiceMenu_TradeCenter_Colosseum) / sizeof((sScriptMultiChoiceMenu_TradeCenter_Colosseum)[0])) },
    { sScriptMultiChoiceMenu_Link_Wireless, (sizeof(sScriptMultiChoiceMenu_Link_Wireless) / sizeof((sScriptMultiChoiceMenu_Link_Wireless)[0])) },
    { sScriptMultiChoiceMenu_GameCornerBattleItemPrizes, (sizeof(sScriptMultiChoiceMenu_GameCornerBattleItemPrizes) / sizeof((sScriptMultiChoiceMenu_GameCornerBattleItemPrizes)[0])) },
    { sScriptMultiChoiceMenu_RocketHideoutElevator, (sizeof(sScriptMultiChoiceMenu_RocketHideoutElevator) / sizeof((sScriptMultiChoiceMenu_RocketHideoutElevator)[0])) },
    { sScriptMultiChoiceMenu_LinkedDirectUnion, (sizeof(sScriptMultiChoiceMenu_LinkedDirectUnion) / sizeof((sScriptMultiChoiceMenu_LinkedDirectUnion)[0])) },
    { sScriptMultiChoiceMenu_Island23, (sizeof(sScriptMultiChoiceMenu_Island23) / sizeof((sScriptMultiChoiceMenu_Island23)[0])) },
    { sScriptMultiChoiceMenu_Island13, (sizeof(sScriptMultiChoiceMenu_Island13) / sizeof((sScriptMultiChoiceMenu_Island13)[0])) },
    { sScriptMultiChoiceMenu_Island12, (sizeof(sScriptMultiChoiceMenu_Island12) / sizeof((sScriptMultiChoiceMenu_Island12)[0])) },
    { sScriptMultiChoiceMenu_TradeColosseumCrush, (sizeof(sScriptMultiChoiceMenu_TradeColosseumCrush) / sizeof((sScriptMultiChoiceMenu_TradeColosseumCrush)[0])) },
    { sScriptMultiChoiceMenu_48, (sizeof(sScriptMultiChoiceMenu_48) / sizeof((sScriptMultiChoiceMenu_48)[0])) },
    { sScriptMultiChoiceMenu_PokejumpDodrio, (sizeof(sScriptMultiChoiceMenu_PokejumpDodrio) / sizeof((sScriptMultiChoiceMenu_PokejumpDodrio)[0])) },
    { sScriptMultiChoiceMenu_TradeColosseum_2, (sizeof(sScriptMultiChoiceMenu_TradeColosseum_2) / sizeof((sScriptMultiChoiceMenu_TradeColosseum_2)[0])) },
    { sScriptMultiChoiceMenu_Mushrooms, (sizeof(sScriptMultiChoiceMenu_Mushrooms) / sizeof((sScriptMultiChoiceMenu_Mushrooms)[0])) },
    { sScriptMultiChoiceMenu_TradeColosseumBlankCrush, (sizeof(sScriptMultiChoiceMenu_TradeColosseumBlankCrush) / sizeof((sScriptMultiChoiceMenu_TradeColosseumBlankCrush)[0])) },
    { sScriptMultiChoiceMenu_TradeColosseumBlank, (sizeof(sScriptMultiChoiceMenu_TradeColosseumBlank) / sizeof((sScriptMultiChoiceMenu_TradeColosseumBlank)[0])) },
    { sScriptMultiChoiceMenu_SeviiNavel, (sizeof(sScriptMultiChoiceMenu_SeviiNavel) / sizeof((sScriptMultiChoiceMenu_SeviiNavel)[0])) },
    { sScriptMultiChoiceMenu_SeviiBirth, (sizeof(sScriptMultiChoiceMenu_SeviiBirth) / sizeof((sScriptMultiChoiceMenu_SeviiBirth)[0])) },
    { sScriptMultiChoiceMenu_SeviiNavelBirth, (sizeof(sScriptMultiChoiceMenu_SeviiNavelBirth) / sizeof((sScriptMultiChoiceMenu_SeviiNavelBirth)[0])) },
    { sScriptMultiChoiceMenu_Seagallop123, (sizeof(sScriptMultiChoiceMenu_Seagallop123) / sizeof((sScriptMultiChoiceMenu_Seagallop123)[0])) },
    { sScriptMultiChoiceMenu_SeagallopV23, (sizeof(sScriptMultiChoiceMenu_SeagallopV23) / sizeof((sScriptMultiChoiceMenu_SeagallopV23)[0])) },
    { sScriptMultiChoiceMenu_SeagallopV13, (sizeof(sScriptMultiChoiceMenu_SeagallopV13) / sizeof((sScriptMultiChoiceMenu_SeagallopV13)[0])) },
    { sScriptMultiChoiceMenu_SeagallopV12, (sizeof(sScriptMultiChoiceMenu_SeagallopV12) / sizeof((sScriptMultiChoiceMenu_SeagallopV12)[0])) },
    { sScriptMultiChoiceMenu_SeagallopVermilion, (sizeof(sScriptMultiChoiceMenu_SeagallopVermilion) / sizeof((sScriptMultiChoiceMenu_SeagallopVermilion)[0])) },
    { sScriptMultiChoiceMenu_62, (sizeof(sScriptMultiChoiceMenu_62) / sizeof((sScriptMultiChoiceMenu_62)[0])) },
    { sScriptMultiChoiceMenu_JoinOrLead, (sizeof(sScriptMultiChoiceMenu_JoinOrLead) / sizeof((sScriptMultiChoiceMenu_JoinOrLead)[0])) },
    { sScriptMultiChoiceMenu_TrainerTowerMode, (sizeof(sScriptMultiChoiceMenu_TrainerTowerMode) / sizeof((sScriptMultiChoiceMenu_TrainerTowerMode)[0])) }
};
...
static void MultiChoicePrintHelpDescription(u8 mcId)
{
    ...
    case 39:
        ...
        AddTextPrinterParameterized2(0, FONT_2, sDescriptionPtrs_CableClub_TradeBattleCancel[Menu_GetCursorPos()], 0, ((void *)0), 0x2, 0x1, 0x3);
        break;
    case 47:
        FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
        AddTextPrinterParameterized2(0, FONT_2, sDescriptionPtrs_WirelessCenter_TradeBattleCrushCancel[Menu_GetCursorPos()], 0, ((void *)0), 0x2, 0x1, 0x3);
        break;
    case 50:
        FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
        AddTextPrinterParameterized2(0, FONT_2, sDescriptionPtrs_WirelessCenter_TradeBattleCancel[Menu_GetCursorPos()], 0, ((void *)0), 0x2, 0x1, 0x3);
        break;
    }
}
...
static void CreatePCMenuWindow(void)
{
    ...
    if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x2C)))
    {
        ...
        SetStdWindowBorderStyle(windowId, 0);
        AddTextPrinterParameterized(windowId, FONT_2, gText_ProfOakSPc, cursorWidth, 34, 0xFF, ((void *)0));
        AddTextPrinterParameterized(windowId, FONT_2, gText_HallOfFame_2, cursorWidth, 50, 0xFF, ((void *)0));
        AddTextPrinterParameterized(windowId, FONT_2, gText_LogOff, cursorWidth, 66, 0xFF, ((void *)0));
    }
    else
    {
        if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x29)))
        ...
        if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x29)))
            AddTextPrinterParameterized(windowId, FONT_2, gText_ProfOakSPc, cursorWidth, 34, 0xFF, ((void *)0));
        AddTextPrinterParameterized(windowId, FONT_2, gText_LogOff, cursorWidth, 2 + 16 * (nitems - 1), 0xFF, ((void *)0));
    }
    if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x34)))
        AddTextPrinterParameterized(windowId, FONT_2, gText_BillSPc, cursorWidth, 2 , 0xFF, ((void *)0));
    else
        AddTextPrinterParameterized(windowId, FONT_2, gText_SomeoneSPc, cursorWidth, 2 , 0xFF, ((void *)0));
    ...
    CreateMCMenuInputHandlerTask(0, nitems, windowId, 0xFF);
    ScheduleBgCopyTilemapToVram(0);
}
...
void ScriptMenu_DisplayPCStartupPrompt(void)
{
    ...
    AddTextPrinterParameterized2(0, FONT_2, Text_AccessWhichPC, 0, ((void *)0), 0x2, 0x1, 0x3);
}
    ...
    if (QuestLog_SchedulePlaybackCB(QLPlaybackCB_DestroyScriptMenuMonPicSprites) != 1)
    {
        ...
        for (i = 0; i < nitems - 2; i++)
        {
            if (r4 != gSpecialVar_0x8004)
                AddTextPrinterParameterized(windowId, FONT_2, sSeagallopDestStrings[r4], cursorWidth, i * 16 + 2, 0xFF, ((void *)0));
            else
                i--;
            r4++;
            if (r4 == 8)
        ...
        AddTextPrinterParameterized(windowId, FONT_2, gText_Other, cursorWidth, i * 16 + 2, 0xFF, ((void *)0));
        i++;
        AddTextPrinterParameterized(windowId, FONT_2, gOtherText_Exit, cursorWidth, i * 16 + 2, 0xFF, ((void *)0));
        Menu_InitCursor(windowId, FONT_2, 0, 2, 16, nitems, 0);
        CreateMCMenuInputHandlerTask(0, nitems, windowId, 0xFF);
        ScheduleBgCopyTilemapToVram(0);
    }
