...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_LOAD:
        ...
        AddTextPrinterParameterized2(0, FONT_2, sMainMenuTexts[task->data[1]].desc, 0xFF, ((void *)0), 0x2, 0x1, 0x3);
    ...
    case STATE_HANDLE_INPUT:
        ...
        case -2:
            ...
            if (task->data[1] != task->data[3])
            {
                ...
                FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
                AddTextPrinterParameterized2(0, FONT_2, sMainMenuTexts[task->data[1]].desc, 0, ((void *)0), 0x2, 0x1, 0x3);
            }
            break;
        case -1:
        case OPTION_EXIT:
        ...
        default:
            if (task->data[2] == OPTION_WITHDRAW && CountPartyMons() == 6)
            {
                ...
                FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
                AddTextPrinterParameterized2(0, FONT_2, gText_PartyFull, 0, ((void *)0), 0x2, 0x1, 0x3);
            ...
            else if (task->data[2] == OPTION_DEPOSIT && CountPartyMons() == 1)
            {
                ...
                FillWindowPixelBuffer(0, ((1) | ((1) << 4)));
                AddTextPrinterParameterized2(0, FONT_2, gText_JustOnePkmn, 0, ((void *)0), 0x2, 0x1, 0x3);
                task->data[0] = STATE_ERROR_MSG;
            }
            else
            {
...
static void CreatePCMainMenu(u8 whichMenu, s16 *windowIdPtr)
{
    ...
    PrintTextArray(windowId, FONT_2, GetMenuCursorDimensionByFont(FONT_2, 0), 2, 16, (sizeof(sMainMenuTexts) / sizeof((sMainMenuTexts)[0])), (void *)sMainMenuTexts);
    Menu_InitCursor(windowId, FONT_2, 0, 2, 16, (sizeof(sMainMenuTexts) / sizeof((sMainMenuTexts)[0])), whichMenu);
