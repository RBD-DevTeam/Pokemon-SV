...
static __attribute__((section("ewram_data"))) const struct YesNoFuncTable *gUnknown_20399C8 = ((void *)0);
static __attribute__((section("ewram_data"))) TaskFunc gUnknown_20399CC = ((void *)0);
static __attribute__((section("ewram_data"))) u8 gUnknown_20399D0 = {0};
...
bool8 itemid_link_can_give_berry(u16 itemId)
{
    if (itemId != 175)
        return 1;
    else if (gSaveBlock1Ptr->location.mapGroup == ((1 | (0 << 8)) >> 8)
