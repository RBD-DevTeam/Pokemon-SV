...
static void PrintRecordsText(u8 windowId)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_2, sRecordsTexts[0], 1, 1, 0xFF, ((void *)0));
    for (i = 0; i < 3; i++)
    {
        ...
        AddTextPrinterParameterized(windowId, FONT_2, sRecordsTexts[i + 1], 1, sRecordTextYCoords[i][0], 0xFF, ((void *)0));
        x = 240 - 16 - numWidth;
        AddTextPrinterParameterized(windowId, FONT_2, strbuf, x, sRecordNumYCoords[i][0], 0xFF, ((void *)0));
    }
...
static void ShowNames(void)
{
    ...
    case 0:
        ...
        for (i = 0; i < numPlayers; coords++, i++)
        {
            ...
            AddTextPrinterParameterized3(sGfx->windowIds[i], FONT_0, left, 1, sTextColorTable[colorsId], 0xFF, name);
...
static void PrintRankedScores(u8 numPlayers_)
{
    ...
    for (i = 0; i < numPlayers; i++)
    {
        ...
        AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, sRankingTexts[scoreResults[playerId].ranking], 8, sRankingYCoords[i], 0xFF, ((void *)0));
        if (playerId == GetMultiplayerId())
            colorsId =COLORID_BLUE;
        name = GetPlayerName(playerId);
        AddTextPrinterParameterized3(sGfx->windowIds[1], FONT_0, 28, sRankingYCoords[i], sTextColorTable[colorsId], 0xFF, name);
        ConvertIntToDecimalStringN(numString, points, STR_CONV_MODE_RIGHT_ALIGN, 7);
        numWidth = GetStringWidth(FONT_0, numString, -1);
        AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, numString, x - 35, sRankingYCoords[i], 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, gText_SpacePoints, x, sRankingYCoords[i], 0xFF, ((void *)0));
    }
}
...
static void ShowResults(void)
{
    ...
    case 2:
        ...
        x = (240 - 16 - strWidth) / 2;
        AddTextPrinterParameterized(sGfx->windowIds[0], FONT_0, gText_BerryPickingResults, x, 2, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, gText_10P30P50P50P, 68, 16, 0xFF, ((void *)0));
        for (i = 0; i < numPlayers; i++)
        {
            u8 colorsId = COLORID_GRAY;
            ...
            AddTextPrinterParameterized3(sGfx->windowIds[1], FONT_0, 2, sResultsYCoords[i], sTextColorTable[colorsId], 0xFF, name);
            for (j = 0; j < 4; j++)
            {
                u32 width;
                ...
                if (maxBerriesPicked == berriesPicked && maxBerriesPicked != 0)
                    AddTextPrinterParameterized3(sGfx->windowIds[1], FONT_0, sResultsXCoords[j] - width, sResultsYCoords[i], sTextColorTable[1], 0xFF, strBuff_Large);
                else
                    AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, strBuff_Large, sResultsXCoords[j] - width, sResultsYCoords[i], 0xFF, ((void *)0));
            }
        }
    ...
    case 5:
        ...
        x = (240 - 16 - strWidth) / 2;
        AddTextPrinterParameterized(sGfx->windowIds[0], FONT_0, gText_AnnouncingRankings, x, 2, 0xFF, ((void *)0));
        sGfx->state++;
        break;
    case 6:
    ...
    case 9:
        ...
        x = (240 - 16 - strWidth) / 2;
        AddTextPrinterParameterized(sGfx->windowIds[0], FONT_0, gText_AnnouncingPrizes, x, 2, 0xFF, ((void *)0));
        ...
        AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, strBuff_Large, 8, 2, 0xFF, ((void *)0));
        ...
        if (prizeState != PRIZE_RECEIVED && prizeState != NO_PRIZE)
        {
            ...
            AddTextPrinterParameterized(sGfx->windowIds[1], FONT_0, strBuff_Large, 8, 40, 0xFF, ((void *)0));
        }
        CopyWindowToVram(sGfx->windowIds[0], COPYWIN_GFX);
        CopyWindowToVram(sGfx->windowIds[1], COPYWIN_GFX);
        sGfx->state++;
...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 1:
        ...
        AddTextPrinterParameterized(sGfx->windowIds[WIN_PLAY_AGAIN], FONT_2, gText_WantToPlayAgain, 0, 6, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_Yes, 8, 2, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_No, 8, 16, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_SelectorArrow2, 0, 2, 0xFF, ((void *)0));
    ...
    case 3:
        ...
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_Yes, 8, 2, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_No, 8, 16, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], FONT_2, gText_SelectorArrow2, 0, y == 1 ? 2 : 16, 0xFF, ((void *)0));
...
static void Msg_SavingDontTurnOff(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized2(0, FONT_2, gText_SavingDontTurnOffThePower2, 0, ((void *)0), 0x2, 0x1, 0x3);
        sGfx->state++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 1:
        FillWindowPixelBuffer(sGfx->windowIds[0], ((1) | ((1) << 4)));
        AddTextPrinterParameterized(sGfx->windowIds[0], FONT_2, gText_CommunicationStandby3, 0, 6, 0xFF, ((void *)0));
        CopyWindowToVram(sGfx->windowIds[0], COPYWIN_GFX);
        sGfx->state++;
        break;
    case 2:
...
static void Msg_SomeoneDroppedOut(void)
{
    ...
    case 1:
        FillWindowPixelBuffer(sGfx->windowIds[0], ((1) | ((1) << 4)));
        AddTextPrinterParameterized(sGfx->windowIds[0], FONT_2, gText_SomeoneDroppedOut, 0, 6, 0xFF, ((void *)0));
        CopyWindowToVram(sGfx->windowIds[0], COPYWIN_GFX);
        sGfx->state++;
        break;
    case 2:
