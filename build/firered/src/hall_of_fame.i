...
static void Task_Hof_SpawnPlayerPic(u8 taskId)
{
    ...
    ShowBg(1);
    ShowBg(3);
    gTasks[taskId].data[4] = CreateTrainerPicSprite(PlayerGenderToFrontTrainerPicId_Debug(gSaveBlock2Ptr->playerGender, 1), 1, 0x78, 0x48, 6, 0xFFFF);
...
static void Task_Hof_WaitAndPrintPlayerInfo(u8 taskId)
{
    ...
    else
    {
        ...
        DrawDialogueFrame(0, 0);
        AddTextPrinterParameterized2(0, FONT_2, gText_LeagueChamp, 0, ((void *)0), 0x2, 0x1, 0x3);
        CopyWindowToVram(0, COPYWIN_FULL);
...
static void Task_Hof_HandlePaletteOnExit(u8 taskId)
{
    CpuSet(gPlttBufferFaded, gPlttBufferUnfaded, 0x00000000 | ((0x200 * sizeof(u16))/(16/8) & 0x1FFFFF));
...
static void Task_HofPC_PrintDataIsCorrupted(u8 taskId)
{
    ...
    DrawDialogueFrame(0, 0);
    AddTextPrinterParameterized2(0, FONT_2, gText_HOFCorrupted, 0, ((void *)0), 0x2, 0x1, 0x3);
    CopyWindowToVram(0, COPYWIN_FULL);
