...
{
    if (gQuestLogState == 3)
        sPalettesBackup = AllocZeroed(0x400);
}

void QuestLog_BackUpPalette(u16 offset, u16 size)
{
    CpuSet(gPlttBufferUnfaded + offset, sPalettesBackup + offset, 0x00000000 | ((size * 2)/(16/8) & 0x1FFFFF));
}
...
static void Task_EndQuestLog(u8 taskId)
{
    ...
    default:
        if (sQuestLogCurrentScene.sceneEndMode == 1)
            ShowMapNamePopup(1);
        CpuSet(sPalettesBackup, gPlttBufferUnfaded, 0x00000000 | ((0x400)/(16/8) & 0x1FFFFF));
...
static void QL_SlightlyDarkenSomePals(void)
{
    ...
    CpuSet(sPalettesBackup, buffer, 0x00000000 | ((0x400)/(16/8) & 0x1FFFFF));
    ...
    CpuSet(sPalettesBackup, gPlttBufferUnfaded, 0x00000000 | ((0x400)/(16/8) & 0x1FFFFF));
    CpuSet(buffer, sPalettesBackup, 0x00000000 | ((0x400)/(16/8) & 0x1FFFFF));
    Free(buffer);
}
