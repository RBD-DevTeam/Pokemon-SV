...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_2, gText_WantToPlayAgain2, 0, 2, 0xFF, ((void *)0));
...
static void Msg_SavingDontTurnOff(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_2, gText_SavingDontTurnOffPower, 0, 2, 0xFF, ((void *)0));
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_SomeoneDroppedOut(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_2, gText_SomeoneDroppedOut2, 0, 2, 0xFF, ((void *)0));
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_2, gText_CommunicationStandby4, 0, 2, 0xFF, ((void *)0));
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void PrintPrizeMessage(u16 itemId, u16 quantity)
{
    ...
    AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_2, sPokemonJumpGfx->prizeMsg, 0, 2, 0xFF, ((void *)0));
    CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
...
static void PrintPokeJumpPlayerName(int multiplayerId, u8 bgColor, u8 fgColor, u8 shadow)
{
    ...
    x /= 2;
    AddTextPrinterParameterized3(sPokemonJumpGfx->nameWindowIds[multiplayerId], FONT_0, x, 2, colors, 0xFF, GetPokeJumpPlayerName(multiplayerId));
...
static void PrintRecordsText(u16 windowId)
{
    ...
    FillWindowPixelBuffer(windowId, ((1) | ((1) << 4)));
    AddTextPrinterParameterized5(windowId, FONT_2, gText_PkmnJumpRecords, 0, 0, 0xFF, ((void *)0), 1, 0);
    for (i = 0; i < (sizeof(sRecordsTexts) / sizeof((sRecordsTexts)[0])); i++)
    {
        AddTextPrinterParameterized5(windowId, FONT_2, sRecordsTexts[i], 0, 20 + (i * 14), 0xFF, ((void *)0), 1, 0);
        ...
        AddTextPrinterParameterized5(windowId, FONT_2, strbuf, x, 20 + (i * 14), 0xFF, ((void *)0), 0, 0);
    }
